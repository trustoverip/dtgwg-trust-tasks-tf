...
window.TT_LIBRARIES = [
  ...
  },
  {
    ...
    summary:
      "One library per specification plus the §7.2 pipeline, with no dependencies. Outcomes are a sealed hierarchy, so a switch over them is exhaustive; closed value sets are extension types rather than enums, so a value from a newer MINOR is carried through instead of throwing (§5.2).",
    capabilities: [
      "types", "pipeline", "schemas", "freshness", "replay", "errors",
      "transport-seam",
    ],
