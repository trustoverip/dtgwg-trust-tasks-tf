...
- a repository reserved by [`git-ns/repo/create`](../../../../git-ns/repo/create/0.1/spec.md) in a namespace where a person had to create it, once they have.
...
Durable, as for [`git-ns/repo/create`](../../../../git-ns/repo/create/0.1/spec.md).
