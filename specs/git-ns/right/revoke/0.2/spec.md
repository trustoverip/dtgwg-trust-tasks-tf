...
Revokes one recorded git right and withdraws it from the VTC's Trust Registry and, through the bridge, from the forge. The counterpart of [`git-ns/right/grant`](../../../../git-ns/right/grant/0.2/spec.md), whose [rights model](../../../../git-ns/right/grant/0.2/spec.md#the-rights-model) this specification relies on.
