...
/// Registry Record Delete — response payload
class Response {
  const Response({
    required this.ok,
    this.message,
...
/// An administrator asks a trust registry to delete the trust record identified by the
/// four TRQP identifiers.
class Payload {
  const Payload({
...
const String typeUri = 'https://trusttasks.org/spec/registry/record/delete/0.1';
...
const String responsePayloadSchemaJson =
    '{"\$schema":"https://json-schema.org/draft/2020-12/schema","\$ref":"#/\$defs/Response","\$defs":{"Response":{"\$anchor":"response","title":"Registry Record Delete — response payload","type":"object","additionalProperties":false,"required":["ok"],"properties":{"ok":{"type":"boolean","description":"Whether the record was deleted."},"message":{"type":"string","maxLength":1024,"description":"Optional human-readable detail."},"ext":{"\$ref":"#/\$defs/Ext"}}},"Ext":{"title":"Ext","description":"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.","type":"object","minProperties":1,"additionalProperties":true,"propertyNames":{"pattern":"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+\$"}}}}';
