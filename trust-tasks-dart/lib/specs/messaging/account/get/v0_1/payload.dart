...
// Source: specs/messaging/account/get/0.1/payload.schema.json
...
/// The success response to a messaging/account/get request. Carried in a Trust Task
/// document whose type is
/// https://trusttasks.org/spec/messaging/account/get/0.1#response.
class Response {
  const Response({
...
const String typeUri = 'https://trusttasks.org/spec/messaging/account/get/0.1';
