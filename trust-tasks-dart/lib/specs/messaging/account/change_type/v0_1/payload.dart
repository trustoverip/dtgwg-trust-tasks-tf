...
/// The success response to a messaging/account/change-type request. Carried in a Trust
/// Task document whose type is
/// https://trusttasks.org/spec/messaging/account/change-type/0.1#response.
class Response {
  const Response({
  ...
  /// The full realized mediator view of the account after the role change.
...
/// Messaging Change Account Type — payload
class Payload {
  const Payload({
    required this.did,
    required this.accountType,
  ...
  /// The role to assign. Assigning or modifying the rootAdmin role requires the
  /// requester to be a rootAdmin.
  final AccountType accountType;
