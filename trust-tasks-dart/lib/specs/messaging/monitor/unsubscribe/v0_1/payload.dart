...
/// The success response to a messaging/monitor/unsubscribe request. Carried in a Trust
...
class Response {
  ...
  factory Response.fromJson(Map<String, dynamic> json) => Response(
        eventsSent: json['eventsSent'] as int?,
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
        if (eventsSent != null) 'eventsSent': eventsSent!,
        if (eventsDropped != null) 'eventsDropped': eventsDropped!,
        if (ext != null) 'ext': ext!,
      };
}

/// Messaging — Unsubscribe from Traffic Monitor — payload
class Payload {
  const Payload({
...
const String responsePayloadSchemaJson =
    '{"\$schema":"https://json-schema.org/draft/2020-12/schema","\$ref":"#/\$defs/Response","\$defs":{"Response":{"\$anchor":"response","title":"Messaging — Unsubscribe from Traffic Monitor — response payload","description":"The success response to a messaging/monitor/unsubscribe request. Carried in a Trust Task document whose type is https://trusttasks.org/spec/messaging/monitor/unsubscribe/0.1#response.","type":"object","additionalProperties":false,"properties":{"eventsSent":{"type":"integer","minimum":0},"eventsDropped":{"type":"integer","minimum":0},"ext":{"\$ref":"#/\$defs/Ext","description":"Ecosystem-defined extension members per SPEC.md §4.5.1."}}},"Ext":{"title":"Ext","description":"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.","type":"object","minProperties":1,"additionalProperties":true,"propertyNames":{"pattern":"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+\$"}}}}';
