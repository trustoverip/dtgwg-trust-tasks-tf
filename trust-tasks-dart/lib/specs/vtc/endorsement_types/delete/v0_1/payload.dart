...
/// VTC Endorsement-Types Delete — response payload
class Response {
  const Response({
...
/// VTC Endorsement-Types Delete — payload
class Payload {
  const Payload({
    required this.typeUri,
    this.ext,
...
const String responsePayloadSchemaJson =
    '{"\$schema":"https://json-schema.org/draft/2020-12/schema","\$ref":"#/\$defs/Response","\$defs":{"Response":{"\$anchor":"response","title":"VTC Endorsement-Types Delete — response payload","type":"object","additionalProperties":false,"required":["typeUri"],"properties":{"typeUri":{"type":"string","minLength":1},"ext":{"\$ref":"#/\$defs/Ext"}}},"Ext":{"title":"Ext","description":"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.","type":"object","minProperties":1,"additionalProperties":true,"propertyNames":{"pattern":"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+\$"}}}}';
