...
/// VTC Members Renew — response payload
class Response {
  const Response({
    required this.did,
    required this.vmc,
...
const String typeUri = 'https://trusttasks.org/spec/vtc/members/renew/0.1';

/// The success-response form of [typeUri] (SPEC §4.4.1).
const String responseTypeUri =
    'https://trusttasks.org/spec/vtc/members/renew/0.1#response';
