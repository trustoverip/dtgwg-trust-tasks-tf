...
/// VTC Members Request VMC — response payload
class Response {
  const Response({
...
/// VTC Members Request VMC — payload
class Payload {
  const Payload({
...
const String responsePayloadSchemaJson =
    '{"\$schema":"https://json-schema.org/draft/2020-12/schema","\$ref":"#/\$defs/Response","\$defs":{"Response":{"\$anchor":"response","title":"VTC Members Request VMC — response payload","type":"object","additionalProperties":false,"required":["acknowledged"],"properties":{"acknowledged":{"type":"boolean","description":"The member received the request. NOT a commitment to issue — the credential arrives separately as vtc/members/vmc, or never."},"ext":{"\$ref":"#/\$defs/Ext"}}},"Ext":{"title":"Ext","description":"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.","type":"object","minProperties":1,"additionalProperties":true,"propertyNames":{"pattern":"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+\$"}}}}';
