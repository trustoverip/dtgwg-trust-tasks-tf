...
/// VTC Members Personhood-Revoke — response payload
class Response {
  const Response({
    required this.did,
  ...
  /// Newly-minted membership credential carrying personhood false; omitted on an
  /// idempotent no-op.
...
/// VTC Members Personhood-Revoke — payload
class Payload {
  const Payload({
    required this.did,
    this.ext,
...
const String responseTypeUri =
    'https://trusttasks.org/spec/vtc/members/personhood/revoke/0.1#response';
