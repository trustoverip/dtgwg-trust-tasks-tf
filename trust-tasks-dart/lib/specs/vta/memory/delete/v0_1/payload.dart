...
/// Success response to vta/memory/delete. Type
...
const String typeUri = 'https://trusttasks.org/spec/vta/memory/delete/0.1';
...
const String responsePayloadSchemaJson =
    '{"\$schema":"https://json-schema.org/draft/2020-12/schema","\$ref":"#/\$defs/Response","\$defs":{"Response":{"\$anchor":"response","title":"VTA Memory Delete — response payload","description":"Success response to vta/memory/delete. Type https://trusttasks.org/spec/vta/memory/delete/0.1#response.","type":"object","additionalProperties":false,"required":["key"],"properties":{"key":{"type":"string","description":"The forgotten item\'s key."},"ext":{"\$ref":"#/\$defs/Ext"}}},"Ext":{"title":"Ext","description":"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.","type":"object","minProperties":1,"additionalProperties":true,"propertyNames":{"pattern":"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+\$"}}}}';
