...
/// Success response to vta/webvh/servers/remove. Type
...
class Response {
  ...
  /// Whether the registration was removed. Removing it does not unpublish anything: DIDs
  /// the server already serves keep resolving, and the VTA simply loses its route for
  /// updating them.
  final bool removed;
  final Ext? ext;
...
/// VTA WebVH Servers Remove — payload
class Payload {
  const Payload({
    required this.id,
    this.ext,
