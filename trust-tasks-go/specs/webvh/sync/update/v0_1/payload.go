...
// Response WebVH Sync Update — response payload
...
// Payload WebVH Sync Update — payload
type Payload struct {
	Mnemonic       string  `json:"mnemonic"`
	DIDID          string  `json:"didId"`
	LogContent     string  `json:"logContent"`
	WitnessContent *string `json:"witnessContent,omitempty"`
	VersionCount   int64   `json:"versionCount"`
	Ext            *Ext    `json:"ext,omitempty"`
}

// TypeURI is the Trust Task type URI this package's Payload is carried under.
const TypeURI = "https://trusttasks.org/spec/webvh/sync/update/0.1"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/webvh/sync/update/0.1#response"
...
const ResponsePayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$ref\":\"#/$defs/Response\",\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"WebVH Sync Update — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"mnemonic\",\"status\"],\"properties\":{\"mnemonic\":{\"type\":\"string\"},\"status\":{\"type\":\"string\",\"enum\":[\"applied\"]},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"
