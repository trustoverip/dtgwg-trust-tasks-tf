...
package registryrecorddeletev0_1
...
// Response Registry Record Delete — response payload
...
// Payload An administrator asks a trust registry to delete the trust record identified by
...
const TypeURI = "https://trusttasks.org/spec/registry/record/delete/0.1"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/registry/record/delete/0.1#response"
...
const PayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$id\":\"https://trusttasks.org/spec/registry/record/delete/0.1\",\"title\":\"Registry Record Delete — payload\",\"description\":\"An administrator asks a trust registry to delete the trust record identified by the four TRQP identifiers.\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"entity_id\",\"authority_id\",\"action\",\"resource\"],\"properties\":{\"entity_id\":{\"type\":\"string\"},\"authority_id\":{\"type\":\"string\"},\"action\":{\"type\":\"string\"},\"resource\":{\"type\":\"string\"},\"ext\":{\"$ref\":\"#/$defs/Ext\"}},\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"Registry Record Delete — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\",\"description\":\"Whether the record was deleted.\"},\"message\":{\"type\":\"string\",\"maxLength\":1024,\"description\":\"Optional human-readable detail.\"},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"

// ResponsePayloadSchemaJSON is PayloadSchemaJSON for the success-response variant.
const ResponsePayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$ref\":\"#/$defs/Response\",\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"Registry Record Delete — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\",\"description\":\"Whether the record was deleted.\"},\"message\":{\"type\":\"string\",\"maxLength\":1024,\"description\":\"Optional human-readable detail.\"},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"
