...
// Source: specs/did-management/domain/assign/0.1/payload.schema.json

package didmanagementdomainassignv0_1
...
// Response Domain Assign — response payload
...
const TypeURI = "https://trusttasks.org/spec/did-management/domain/assign/0.1"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/did-management/domain/assign/0.1#response"
...
const PayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$id\":\"https://trusttasks.org/spec/did-management/domain/assign/0.1\",\"title\":\"Domain Assign — payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"instanceId\",\"domain\"],\"properties\":{\"instanceId\":{\"type\":\"string\",\"minLength\":1},\"domain\":{\"type\":\"string\",\"minLength\":1},\"ext\":{\"$ref\":\"#/$defs/Ext\"}},\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"Domain Assign — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"instanceId\",\"domain\",\"status\"],\"properties\":{\"instanceId\":{\"type\":\"string\"},\"domain\":{\"type\":\"string\"},\"status\":{\"type\":\"string\",\"enum\":[\"queued\"]},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"

// ResponsePayloadSchemaJSON is PayloadSchemaJSON for the success-response variant.
const ResponsePayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$ref\":\"#/$defs/Response\",\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"Domain Assign — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"instanceId\",\"domain\",\"status\"],\"properties\":{\"instanceId\":{\"type\":\"string\"},\"domain\":{\"type\":\"string\"},\"status\":{\"type\":\"string\",\"enum\":[\"queued\"]},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"
