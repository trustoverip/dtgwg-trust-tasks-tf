...
package didmanagementdomainunassignv0_1
...
// Response Domain Unassign — response payload
...
// Payload Domain Unassign — payload
type Payload struct {
	InstanceID string `json:"instanceId"`
	Domain     string `json:"domain"`
	Ext        *Ext   `json:"ext,omitempty"`
...
const TypeURI = "https://trusttasks.org/spec/did-management/domain/unassign/0.1"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/did-management/domain/unassign/0.1#response"
...
const ResponsePayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$ref\":\"#/$defs/Response\",\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"Domain Unassign — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"instanceId\",\"domain\",\"status\"],\"properties\":{\"instanceId\":{\"type\":\"string\"},\"domain\":{\"type\":\"string\"},\"status\":{\"type\":\"string\",\"enum\":[\"queued\"]},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"
