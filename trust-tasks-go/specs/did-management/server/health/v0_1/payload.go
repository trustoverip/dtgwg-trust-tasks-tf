...
package didmanagementserverhealthv0_1
...
// Response Server Health — response payload
...
const TypeURI = "https://trusttasks.org/spec/did-management/server/health/0.1"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/did-management/server/health/0.1#response"
...
const PayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$id\":\"https://trusttasks.org/spec/did-management/server/health/0.1\",\"title\":\"Server Health — payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"instanceId\"],\"properties\":{\"instanceId\":{\"type\":\"string\",\"minLength\":1},\"ext\":{\"$ref\":\"#/$defs/Ext\"}},\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"Server Health — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"instanceId\",\"ok\",\"observedAt\"],\"properties\":{\"instanceId\":{\"type\":\"string\"},\"ok\":{\"type\":\"boolean\"},\"observedAt\":{\"type\":\"string\",\"format\":\"date-time\"},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"
