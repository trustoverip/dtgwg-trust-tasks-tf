...
package vtcwebsiterollbackv0_1
...
// Response VTC Website Rollback — response payload
...
// Payload VTC Website Rollback — payload
type Payload struct {
...
const TypeURI = "https://trusttasks.org/spec/vtc/website/rollback/0.1"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/vtc/website/rollback/0.1#response"
