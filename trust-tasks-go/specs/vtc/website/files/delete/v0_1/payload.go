...
// Source: specs/vtc/website/files/delete/0.1/payload.schema.json

package vtcwebsitefilesdeletev0_1
...
// Response VTC Website Files Delete — response payload
...
// Payload VTC Website Files Delete — payload
type Payload struct {
...
const TypeURI = "https://trusttasks.org/spec/vtc/website/files/delete/0.1"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/vtc/website/files/delete/0.1#response"
...
const PayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$id\":\"https://trusttasks.org/spec/vtc/website/files/delete/0.1\",\"title\":\"VTC Website Files Delete — payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"path\"],\"properties\":{\"path\":{\"type\":\"string\",\"minLength\":1,\"description\":\"Path of the file to delete, relative to the site root.\"},\"ext\":{\"$ref\":\"#/$defs/Ext\"}},\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"VTC Website Files Delete — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"path\",\"deleted\"],\"properties\":{\"path\":{\"type\":\"string\",\"minLength\":1},\"deleted\":{\"type\":\"boolean\"},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"
