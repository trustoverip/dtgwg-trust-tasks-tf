...
package vtcmemberspersonhoodchallengev0_1
...
// Response VTC Members Personhood-Challenge — response payload
...
// Payload VTC Members Personhood-Challenge — payload
type Payload struct {
...
const TypeURI = "https://trusttasks.org/spec/vtc/members/personhood/challenge/0.1"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/vtc/members/personhood/challenge/0.1#response"
...
const ResponsePayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$ref\":\"#/$defs/Response\",\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"VTC Members Personhood-Challenge — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"challengeId\",\"expiresAt\"],\"properties\":{\"challengeId\":{\"type\":\"string\",\"minLength\":1,\"description\":\"Single-use nonce (a UUID). Embed it into the assert VP's proof.challenge.\"},\"expiresAt\":{\"type\":\"string\",\"format\":\"date-time\",\"description\":\"The assert handler refuses the presentation past this point.\"},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"
