...
package vtcjoinrequestsstatusv0_1
...
const (
	...
	ResponseStatusDeferred  ResponseStatus = "deferred"
...
// Payload VTC Join-Requests Status — payload
type Payload struct {
	// The request to poll. Optional: an applicant whose first reply was lost never received
	// an id, and the id-less poll — resolved from the authenticated applicant's own DID — is
...
const TypeURI = "https://trusttasks.org/spec/vtc/join-requests/status/0.1"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/vtc/join-requests/status/0.1#response"
