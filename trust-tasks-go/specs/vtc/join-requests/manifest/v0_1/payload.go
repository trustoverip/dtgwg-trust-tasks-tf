...
package vtcjoinrequestsmanifestv0_1
...
// ResponseCriteriaItem ResponseCriteriaItem is a generated payload type.
type ResponseCriteriaItem struct {
	ID          string  `json:"id"`
...
type Response struct {
	...
	Criteria     []ResponseCriteriaItem `json:"criteria"`
...
// Payload VTC Join-Requests Manifest — payload
type Payload struct {
	Ext *Ext `json:"ext,omitempty"`
}

// TypeURI is the Trust Task type URI this package's Payload is carried under.
const TypeURI = "https://trusttasks.org/spec/vtc/join-requests/manifest/0.1"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/vtc/join-requests/manifest/0.1#response"
...
const PayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$id\":\"https://trusttasks.org/spec/vtc/join-requests/manifest/0.1\",\"title\":\"VTC Join-Requests Manifest — payload\",\"type\":\"object\",\"additionalProperties\":false,\"properties\":{\"ext\":{\"$ref\":\"#/$defs/Ext\"}},\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"VTC Join-Requests Manifest — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"communityDid\",\"criteria\"],\"properties\":{\"communityDid\":{\"type\":\"string\",\"minLength\":1},\"criteria\":{\"type\":\"array\",\"items\":{\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"id\",\"presentationDefinition\"],\"properties\":{\"id\":{\"type\":\"string\",\"minLength\":1},\"description\":{\"type\":\"string\",\"maxLength\":1024},\"presentationDefinition\":{\"type\":\"object\",\"description\":\"The presentation-definition an applicant must satisfy for this criterion (opaque here).\"}}}},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"

// ResponsePayloadSchemaJSON is PayloadSchemaJSON for the success-response variant.
const ResponsePayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$ref\":\"#/$defs/Response\",\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"VTC Join-Requests Manifest — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"communityDid\",\"criteria\"],\"properties\":{\"communityDid\":{\"type\":\"string\",\"minLength\":1},\"criteria\":{\"type\":\"array\",\"items\":{\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"id\",\"presentationDefinition\"],\"properties\":{\"id\":{\"type\":\"string\",\"minLength\":1},\"description\":{\"type\":\"string\",\"maxLength\":1024},\"presentationDefinition\":{\"type\":\"object\",\"description\":\"The presentation-definition an applicant must satisfy for this criterion (opaque here).\"}}}},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"
