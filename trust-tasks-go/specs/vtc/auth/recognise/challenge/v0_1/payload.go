...
package vtcauthrecognisechallengev0_1
...
// Response VTC Auth Recognise Challenge — response payload
type Response struct {
	// Single-use, unpredictable value to bind into the presentation. Consumed on first use
...
// Payload VTC Auth Recognise Challenge — payload
type Payload struct {
	Ext *Ext `json:"ext,omitempty"`
}

// TypeURI is the Trust Task type URI this package's Payload is carried under.
const TypeURI = "https://trusttasks.org/spec/vtc/auth/recognise/challenge/0.1"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/vtc/auth/recognise/challenge/0.1#response"
...
const PayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$id\":\"https://trusttasks.org/spec/vtc/auth/recognise/challenge/0.1\",\"title\":\"VTC Auth Recognise Challenge — payload\",\"type\":\"object\",\"additionalProperties\":false,\"properties\":{\"ext\":{\"$ref\":\"#/$defs/Ext\"}},\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"VTC Auth Recognise Challenge — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"nonce\",\"expiresAt\"],\"properties\":{\"nonce\":{\"type\":\"string\",\"minLength\":1,\"description\":\"Single-use, unpredictable value to bind into the presentation. Consumed on first use regardless of verdict.\"},\"expiresAt\":{\"type\":\"integer\",\"minimum\":0,\"description\":\"Unix timestamp after which the nonce is refused.\"},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"

// ResponsePayloadSchemaJSON is PayloadSchemaJSON for the success-response variant.
const ResponsePayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$ref\":\"#/$defs/Response\",\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"VTC Auth Recognise Challenge — response payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"nonce\",\"expiresAt\"],\"properties\":{\"nonce\":{\"type\":\"string\",\"minLength\":1,\"description\":\"Single-use, unpredictable value to bind into the presentation. Consumed on first use regardless of verdict.\"},\"expiresAt\":{\"type\":\"integer\",\"minimum\":0,\"description\":\"Unix timestamp after which the nonce is refused.\"},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"
