...
package vtawebvhserversremovev1_0
...
// Response Success response to vta/webvh/servers/remove. Type
// https://trusttasks.org/spec/vta/webvh/servers/remove/1.0#response.
type Response struct {
	ID string `json:"id"`

	// Whether the registration was removed. Removing it does not unpublish anything: DIDs the
	// server already serves keep resolving, and the VTA simply loses its route for updating
	// them.
...
// Payload VTA WebVH Servers Remove — payload
type Payload struct {
	ID  string `json:"id"`
	Ext *Ext   `json:"ext,omitempty"`
}
...
const TypeURI = "https://trusttasks.org/spec/vta/webvh/servers/remove/1.0"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/vta/webvh/servers/remove/1.0#response"
...
const PayloadSchemaJSON = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$id\":\"https://trusttasks.org/spec/vta/webvh/servers/remove/1.0\",\"title\":\"VTA WebVH Servers Remove — payload\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"id\"],\"properties\":{\"id\":{\"type\":\"string\",\"minLength\":1},\"ext\":{\"$ref\":\"#/$defs/Ext\"}},\"$defs\":{\"Response\":{\"$anchor\":\"response\",\"title\":\"VTA WebVH Servers Remove — response payload\",\"description\":\"Success response to vta/webvh/servers/remove. Type https://trusttasks.org/spec/vta/webvh/servers/remove/1.0#response.\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"id\",\"removed\"],\"properties\":{\"id\":{\"type\":\"string\"},\"removed\":{\"type\":\"boolean\",\"description\":\"Whether the registration was removed. Removing it does not unpublish anything: DIDs the server already serves keep resolving, and the VTA simply loses its route for updating them.\"},\"ext\":{\"$ref\":\"#/$defs/Ext\"}}},\"Ext\":{\"title\":\"Ext\",\"description\":\"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\"type\":\"object\",\"minProperties\":1,\"additionalProperties\":true,\"propertyNames\":{\"pattern\":\"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"}}}}"
