...
package vtawebvhagentnamedisablev1_0
...
// Response Success response to vta/webvh/agent-name/disable. Type
...
// Payload Stop a name resolving while continuing to hold it. Unlike `remove`, nobody else
// can take it.
type Payload struct {
...
const TypeURI = "https://trusttasks.org/spec/vta/webvh/agent-name/disable/1.0"

// ResponseTypeURI is the success-response form of TypeURI (SPEC §4.4.1).
const ResponseTypeURI = "https://trusttasks.org/spec/vta/webvh/agent-name/disable/1.0#response"
