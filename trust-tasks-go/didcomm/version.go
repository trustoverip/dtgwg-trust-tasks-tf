...
// Version is the released version of this module (trust-tasks-go/didcomm).
//
// A Go module has no manifest, and the version of a Go module *is* its git tag
// (here `trust-tasks-go/didcomm/v<Version>`, resolved by proxy.golang.org). As
...
// `trust-tasks-go/didcomm/v<Version>` needs tagging.
//
