...
impl ::std::convert::From<&PayloadTag> for PayloadTag {
    fn from(value: &PayloadTag) -> Self {
        value.clone()
    }
}
...
impl ::std::convert::From<&PayloadTargetAndroidPackage> for PayloadTargetAndroidPackage {
    fn from(value: &PayloadTargetAndroidPackage) -> Self {
        value.clone()
    }
}
...
impl ::std::convert::From<&PayloadTargetDid> for PayloadTargetDid {
    fn from(value: &PayloadTargetDid) -> Self {
        value.clone()
    }
}
...
impl ::std::convert::From<&PayloadTargetIosBundleId> for PayloadTargetIosBundleId {
    fn from(value: &PayloadTargetIosBundleId) -> Self {
        value.clone()
    }
}
