...
//!
//! Spec slug: `vault/release`. Version: `0.2`.
...
pub mod builder {
    ...
    pub struct Response {
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
        sealed_secret: ::std::result::Result<super::SealedEnvelope, ::std::string::String>,
        secret_kind: ::std::result::Result<super::SecretKind, ::std::string::String>,
        ttl_seconds: ::std::result::Result<::std::num::NonZeroU64, ::std::string::String>,
    }
    impl ::std::default::Default for Response {
        fn default() -> Self {
            Self {
                ...
                ttl_seconds: Err("no value supplied for ttl_seconds".to_string()),
            }
        }
    }
    impl Response {
...
pub mod error_codes {
    ...
    ///
    /// The consumer's published recipient key advertises envelope kinds the maintainer does not implement (e.g. consumer requests `tspMessage` against a maintainer that only emits `didcommAuthcrypt`). Producers SHOULD consult `trust-task-discovery/0.1` for the maintainer's emit set.
    ///
    /// Declared `retryable: false`.
