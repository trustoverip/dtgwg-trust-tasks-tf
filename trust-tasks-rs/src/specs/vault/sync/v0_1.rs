...
//!
//! Spec slug: `vault/sync`. Version: `0.1`.
...
impl ::std::fmt::Display for AclChangedEventChange {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            ...
            Self::RoleChanged => f.write_str("role_changed"),
            Self::Swapped => f.write_str("swapped"),
            Self::DeviceDisabled => f.write_str("device_disabled"),
            Self::DeviceWiped => f.write_str("device_wiped"),
        }
    }
}
impl ::std::str::FromStr for AclChangedEventChange {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            ...
            "device_wiped" => Ok(Self::DeviceWiped),
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/vault/sync/0.1",
///  "title": "Payload",
