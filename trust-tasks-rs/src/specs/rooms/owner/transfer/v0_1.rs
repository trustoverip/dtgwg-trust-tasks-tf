...
//!
//! Spec slug: `rooms/owner/transfer`. Version: `0.1`.
...
pub struct Payload {
    ...
    #[serde(rename = "newOwnerDid")]
    pub new_owner_did: ::std::string::String,
...
pub mod builder {
    ...
    pub struct Payload {
        ...
        new_owner_did: ::std::result::Result<::std::string::String, ::std::string::String>,
    ...
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                ...
                new_owner_did: Err("no value supplied for new_owner_did".to_string()),
    ...
    impl Payload {
        ...
        pub fn new_owner_did<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::string::String>,
            T::Error: ::std::fmt::Display,
        {
            self.new_owner_did = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for new_owner_did: {e}"));
            self
        }
    ...
    impl ::std::convert::TryFrom<Payload> for super::Payload {
        ...
        fn try_from(value: Payload) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                ext: value.ext?,
                new_owner_did: value.new_owner_did?,
    ...
    impl ::std::convert::From<super::Payload> for Payload {
        fn from(value: super::Payload) -> Self {
            Self {
                ext: Ok(value.ext),
                new_owner_did: Ok(value.new_owner_did),
...
impl crate::Payload for Payload {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/rooms/owner/transfer/0.1";
...
impl crate::Payload for Response {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/rooms/owner/transfer/0.1#response";
    const IS_PROOF_REQUIRED: bool = true;
    const IS_ISSUED_AT_REQUIRED: bool = true;
    const IS_RECIPIENT_REQUIRED: bool = true;
    const PAYLOAD_SCHEMA: Option<&'static str> = Some(
