...
//!
//! Spec slug: `rooms/owner/invite`. Version: `0.1`.
...
impl crate::Payload for Payload {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/rooms/owner/invite/0.1";
...
impl crate::Payload for Response {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/rooms/owner/invite/0.1#response";
    const IS_PROOF_REQUIRED: bool = true;
    const IS_ISSUED_AT_REQUIRED: bool = true;
    const IS_RECIPIENT_REQUIRED: bool = true;
    const PAYLOAD_SCHEMA: Option<&'static str> = Some(
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::NO_SIGNING_KEY];
...
/// declared.
pub mod error_codes {
    /// `rooms/owner/invite:noSigningKey`
    ///
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            ...
            (
                "An unknown member — additionalProperties: false catches `reason`. Whatever is placed beside the credential travels with it to the invitee, so a free-form note here is a note the room's host may end up reading.",
                "{\n  \"reason\": \"joining the pricing group\",\n  \"roomId\": \"did:webvh:example.com:rooms:northwind\",\n  \"signingKeyId\": \"room-northwind-signing\",\n  \"subject\": \"did:key:z6MkhaXgBZDvotDkL5257faiztiGiC2QtKLGpbnnEGta2doK\"\n}",
            ),
            (
                "validUntil as a date rather than a date-time. An invitation's window is the whole of its safety, and a value that cannot be ordered against an issuedAt is not a window.",
