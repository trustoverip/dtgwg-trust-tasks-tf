...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] =
    &[error_codes::NOT_FOUND, error_codes::FORBIDDEN];
...
/// declared.
pub mod error_codes {
    /// `rooms/epoch/chain:notFound`
    ///
    /// No room with this identifier is served here.
    ///
    ...
    ///
    /// The presentation does not confer `read` at this room's scope, does not verify, or was not made to the party that signed the request.
    ///
    /// Declared `retryable: false`.
