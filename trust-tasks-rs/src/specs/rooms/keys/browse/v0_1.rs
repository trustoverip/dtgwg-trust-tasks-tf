...
/// declared.
pub mod error_codes {
    /// `rooms/keys/browse:notAMember`
    ///
    /// The recipient holds no group state for this room, so it has nothing to present.
    ///
    ...
    /// `rooms/keys/browse:hostUnreachable`
    ///
    ...
    /// `rooms/keys/browse:hostRefused`
    ///
    /// The host answered and declined. Its own code and reason are carried in `details` — commonly that it does not serve this room.
    ///
    /// Declared `retryable: false`.
