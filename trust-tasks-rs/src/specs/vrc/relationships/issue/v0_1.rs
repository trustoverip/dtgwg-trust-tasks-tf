...
pub mod builder {
    ...
    pub struct Payload {
        ...
        vrc: ::std::result::Result<
            ...
            ::std::string::String,
        >,
        vrc_digest_multibase: ::std::result::Result<
    ...
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                ...
                vrc_digest_multibase: Ok(Default::default()),
            }
        }
    }
    impl Payload {
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::NOT_ACCEPTED];
...
/// declared.
pub mod error_codes {
    /// `vrc/relationships/issue:notAccepted`
    ///
    /// The receiving party refuses the delivery — the credential does not match the accepted proposal (wrong parties, wrong relationship DIDs) or arrives outside an accepted exchange.
    ///
    /// Declared `retryable: false`.
    pub const NOT_ACCEPTED: crate::DeclaredErrorCode = crate::DeclaredErrorCode {
