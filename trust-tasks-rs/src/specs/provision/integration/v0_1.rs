...
///    },
///    "context": {
///      "description": "The maintainer's context identifier the integration is to be provisioned into. Authoritative — overrides any `contextHint` carried inside `request.ask`.",
///      "type": "string",
///      "minLength": 1
///    },
///    "createContext": {
