...
//!
//! Spec slug: `provision/integration`. Version: `0.3`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/provision/integration/0.3",
///  "title": "Payload",
...
pub struct Payload {
    ...
    #[serde(rename = "adminScope", default = "defaults::payload_admin_scope")]
    pub admin_scope: PayloadAdminScope,
...
#[non_exhaustive]
pub enum PayloadAdminScope {
    #[serde(rename = "context")]
    Context,
    #[serde(rename = "unrestricted")]
    Unrestricted,
}
impl ::std::fmt::Display for PayloadAdminScope {
...
impl ::std::str::FromStr for PayloadAdminScope {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
...
impl ::std::convert::TryFrom<&str> for PayloadAdminScope {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for PayloadAdminScope {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl ::std::default::Default for PayloadAdminScope {
    fn default() -> Self {
        PayloadAdminScope::Context
    }
}
///Producer-assertion mode the maintainer should apply to the returned sealed bundle. `didSigned` (default) — Ed25519 signature over the bundle's domain-bound digest, verified by the holder against the maintainer's published key. `pinnedOnly` — holder pins the bundle's SHA-256 digest as the sole integrity anchor; for dev/test only. Maintainers MAY support additional modes (e.g. `attested` for TEE deployments) and respond with `provision/integration:assertionUnsupported` to unsupported requests.
///
...
pub struct ProvisionSummary {
    ...
    pub admin_scope: ::std::option::Option<ProvisionSummaryAdminScope>,
    ...
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub context: ::std::option::Option<ProvisionSummaryContext>,
...
#[non_exhaustive]
pub enum ProvisionSummaryAdminScope {
    #[serde(rename = "context")]
    Context,
    #[serde(rename = "unrestricted")]
    Unrestricted,
}
impl ::std::fmt::Display for ProvisionSummaryAdminScope {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            Self::Context => f.write_str("context"),
            Self::Unrestricted => f.write_str("unrestricted"),
...
impl ::std::str::FromStr for ProvisionSummaryAdminScope {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            "context" => Ok(Self::Context),
...
impl ::std::convert::TryFrom<&str> for ProvisionSummaryAdminScope {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for ProvisionSummaryAdminScope {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct ProvisionSummaryContext(::std::string::String);
impl ::std::ops::Deref for ProvisionSummaryContext {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<ProvisionSummaryContext> for ::std::string::String {
    fn from(value: ProvisionSummaryContext) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for ProvisionSummaryContext {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        if value.chars().count() < 1usize {
            return Err("shorter than 1 characters".into());
...
impl ::std::convert::TryFrom<&str> for ProvisionSummaryContext {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for ProvisionSummaryContext {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for ProvisionSummaryContext {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
///    },
///    "digestMultibase": {
///      "description": "Digest over the armored ciphertext, for holders that pin the bundle out-of-band. Taken over the armored bytes exactly as carried in `bundle`, not over a canonicalization: the armor is the artifact, and re-armoring the same ciphertext does not have to reproduce the same bytes.",
...
pub struct Response {
    ...
    pub digest_multibase: ::std::option::Option<DigestMultibase>,
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub ext: ::std::option::Option<Ext>,
...
pub mod builder {
    ...
    #[derive(Clone, Debug)]
    pub struct Payload {
        admin_scope: ::std::result::Result<super::PayloadAdminScope, ::std::string::String>,
    ...
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                admin_scope: Ok(super::defaults::payload_admin_scope()),
    ...
    impl Payload {
        pub fn admin_scope<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::PayloadAdminScope>,
            T::Error: ::std::fmt::Display,
        {
            self.admin_scope = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for admin_scope: {e}"));
            self
        }
    ...
    impl ::std::convert::From<super::Payload> for Payload {
        fn from(value: super::Payload) -> Self {
            Self {
                admin_scope: Ok(value.admin_scope),
    ...
    pub struct ProvisionSummary {
        ...
        admin_scope: ::std::result::Result<
            ::std::option::Option<super::ProvisionSummaryAdminScope>,
            ::std::string::String,
        >,
        ...
        context: ::std::result::Result<
            ::std::option::Option<super::ProvisionSummaryContext>,
            ::std::string::String,
        >,
    ...
    impl ::std::default::Default for ProvisionSummary {
        fn default() -> Self {
            Self {
                ...
                admin_scope: Ok(Default::default()),
    ...
    impl ProvisionSummary {
        ...
        pub fn admin_scope<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::ProvisionSummaryAdminScope>>,
            T::Error: ::std::fmt::Display,
        {
            self.admin_scope = value
                .try_into()
        ...
        pub fn context<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::ProvisionSummaryContext>>,
            T::Error: ::std::fmt::Display,
        {
            self.context = value
                .try_into()
    ...
    pub struct Response {
        ...
        digest_multibase: ::std::result::Result<
    ...
    impl ::std::default::Default for Response {
        fn default() -> Self {
            Self {
                ...
                digest_multibase: Ok(Default::default()),
                ext: Ok(Default::default()),
...
pub mod defaults {
    pub(super) fn payload_admin_scope() -> super::PayloadAdminScope {
        super::PayloadAdminScope::Context
    }
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            ...
            (
                "adminScope outside the enum. `superAdmin` is the word an operator says; the wire names the shape of the ACL entry (`unrestricted` — no context list) rather than the informal name of the role that shape produces.",
