...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::DID_NOT_FOUND];
...
/// declared.
pub mod error_codes {
    /// `vta/passkey-vms/enroll-challenge:didNotFound`
    ///
    /// The target DID is not managed by this VTA, so no challenge can be issued.
    ///
