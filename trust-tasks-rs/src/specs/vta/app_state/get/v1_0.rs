...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] =
    &[error_codes::CONTEXT_NOT_FOUND, error_codes::NOT_FOUND];
...
pub mod error_codes {
    ...
    ///
    /// No record exists at `(contextId, namespace, key)`. Also returned when a tombstone exists but `includeDeleted` was not set.
    ///
    /// Declared `retryable: false`.
