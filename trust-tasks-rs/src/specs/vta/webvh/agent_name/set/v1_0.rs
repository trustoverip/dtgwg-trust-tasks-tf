...
//!
//! Spec slug: `vta/webvh/agent-name/set`. Version: `1.0`.
...
/// declared.
pub mod error_codes {
    /// `vta/webvh/agent-name/set:notFound`
    ///
    /// The DID is unknown to this VTA, unreachable by the caller, or does not hold this name.
    ///
