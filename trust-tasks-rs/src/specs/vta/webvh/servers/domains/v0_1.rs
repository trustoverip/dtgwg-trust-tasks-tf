...
pub mod builder {
    ...
    pub struct Response {
        default: ::std::result::Result<
            ...
            ::std::string::String,
        >,
        domains: ::std::result::Result<::std::vec::Vec<super::DomainEntry>, ::std::string::String>,
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
    }
    impl ::std::default::Default for Response {
        fn default() -> Self {
            Self {
                ...
                domains: Err("no value supplied for domains".to_string()),
                ext: Ok(Default::default()),
            }
        }
    }
    impl Response {
        ...
        where
            T: ::std::convert::TryInto<::std::vec::Vec<super::DomainEntry>>,
            T::Error: ::std::fmt::Display,
        {
            self.domains = value
                .try_into()
