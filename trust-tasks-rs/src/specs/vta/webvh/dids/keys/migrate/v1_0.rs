...
//!
//! Spec slug: `vta/webvh/dids/keys/migrate`. Version: `1.0`.
...
///Move a legacy did:webvh — one key in both authentication and assertionMethod, holding the log's update authority — onto key roles in a single log entry (VTI-KEY-140).
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/vta/webvh/dids/keys/migrate/1.0",
///  "title": "Payload",
///  "description": "Move a legacy did:webvh — one key in both authentication and assertionMethod, holding the log's update authority — onto key roles in a single log entry (VTI-KEY-140).",
///  "type": "object",
///  "required": [
///    "attestationKeyTypes",
///    "did",
...
///  "properties": {
///    "attestationKeyTypes": {
///      "description": "One attestation key is generated per entry — for example `[\"ed25519\", \"mldsa44\"]` for a classical key and a post-quantum key signing as a proof set.",
///      "type": "array",
///      "items": {
///        "$ref": "#/definitions/KeyType"
///      },
...
///    },
///    "gracePeriodEnd": {
///      "description": "The end of the grace period recorded in the entry (VTI-KEY-143): until then a verifier MAY accept an attestation artefact under the legacy key; after it, none. MUST NOT be later than the latest expiry of any artefact the legacy key signed, nor beyond the community's maximum membership period.",
///      "type": "string",
///      "format": "date-time"
///    },
///    "legacyOperationalUntil": {
///      "description": "How long the legacy key may stay in `authentication`, bound to `operational`, before the VTA removes it (VTI-KEY-141). Absent means it is removed from every relationship in the migration entry itself.",
///      "type": "string",
///      "format": "date-time"
///    },
///    "operationalKeyType": {
///      "description": "Algorithm of the new operational key. Absent means `ed25519`.",
///      "$ref": "#/definitions/KeyType"
///    },
///    "previewId": {
...
#[non_exhaustive]
pub struct Payload {
    ///One attestation key is generated per entry — for example `["ed25519", "mldsa44"]` for a classical key and a post-quantum key signing as a proof set.
    #[serde(rename = "attestationKeyTypes")]
    pub attestation_key_types: Vec<KeyType>,
    ...
    ///The end of the grace period recorded in the entry (VTI-KEY-143): until then a verifier MAY accept an attestation artefact under the legacy key; after it, none. MUST NOT be later than the latest expiry of any artefact the legacy key signed, nor beyond the community's maximum membership period.
    #[serde(rename = "gracePeriodEnd")]
    pub grace_period_end: ::chrono::DateTime<::chrono::offset::Utc>,
    ///How long the legacy key may stay in `authentication`, bound to `operational`, before the VTA removes it (VTI-KEY-141). Absent means it is removed from every relationship in the migration entry itself.
    #[serde(
        rename = "legacyOperationalUntil",
        default,
        skip_serializing_if = "::std::option::Option::is_none"
    )]
    pub legacy_operational_until: ::std::option::Option<::chrono::DateTime<::chrono::offset::Utc>>,
    ///Algorithm of the new operational key. Absent means `ed25519`.
    #[serde(
        rename = "operationalKeyType",
        default,
        skip_serializing_if = "::std::option::Option::is_none"
    )]
    pub operational_key_type: ::std::option::Option<KeyType>,
...
///Success response. Type https://trusttasks.org/spec/vta/webvh/dids/keys/migrate/1.0#response. A refusal is a `trust-task-error` document, never this.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "title": "Response",
///  "description": "Success response. Type https://trusttasks.org/spec/vta/webvh/dids/keys/migrate/1.0#response. A refusal is a `trust-task-error` document, never this.",
///  "type": "object",
///  "required": [
///    "did",
///    "keys",
...
pub mod builder {
    ...
    #[derive(Clone, Debug)]
    pub struct Payload {
        attestation_key_types: ::std::result::Result<Vec<super::KeyType>, ::std::string::String>,
        ...
        grace_period_end:
            ::std::result::Result<::chrono::DateTime<::chrono::offset::Utc>, ::std::string::String>,
        legacy_operational_until: ::std::result::Result<
            ::std::option::Option<::chrono::DateTime<::chrono::offset::Utc>>,
            ::std::string::String,
        >,
        operational_key_type:
            ::std::result::Result<::std::option::Option<super::KeyType>, ::std::string::String>,
    ...
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                attestation_key_types: Err(
                    "no value supplied for attestation_key_types".to_string()
                ),
                did: Err("no value supplied for did".to_string()),
                dry_run: Ok(Default::default()),
                expected_version_id: Ok(Default::default()),
                ext: Ok(Default::default()),
                grace_period_end: Err("no value supplied for grace_period_end".to_string()),
                legacy_operational_until: Ok(Default::default()),
                operational_key_type: Ok(Default::default()),
    ...
    impl Payload {
        pub fn attestation_key_types<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<Vec<super::KeyType>>,
            T::Error: ::std::fmt::Display,
        {
            self.attestation_key_types = value.try_into().map_err(|e| {
                format!("error converting supplied value for attestation_key_types: {e}")
            });
            self
        }
        ...
        pub fn legacy_operational_until<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<
                ::std::option::Option<::chrono::DateTime<::chrono::offset::Utc>>,
            >,
            T::Error: ::std::fmt::Display,
        {
            self.legacy_operational_until = value.try_into().map_err(|e| {
                format!("error converting supplied value for legacy_operational_until: {e}")
            });
            self
        }
        pub fn operational_key_type<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::KeyType>>,
            T::Error: ::std::fmt::Display,
        {
            self.operational_key_type = value.try_into().map_err(|e| {
                format!("error converting supplied value for operational_key_type: {e}")
            });
            self
        }
        pub fn preview_id<T>(mut self, value: T) -> Self
    ...
    impl ::std::convert::TryFrom<Payload> for super::Payload {
        ...
        fn try_from(value: Payload) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                attestation_key_types: value.attestation_key_types?,
                did: value.did?,
                dry_run: value.dry_run?,
                expected_version_id: value.expected_version_id?,
                ext: value.ext?,
                grace_period_end: value.grace_period_end?,
                legacy_operational_until: value.legacy_operational_until?,
                operational_key_type: value.operational_key_type?,
                preview_id: value.preview_id?,
                reason: value.reason?,
            })
        }
    ...
    impl ::std::convert::From<super::Payload> for Payload {
        fn from(value: super::Payload) -> Self {
            Self {
                attestation_key_types: Ok(value.attestation_key_types),
                did: Ok(value.did),
                dry_run: Ok(value.dry_run),
                expected_version_id: Ok(value.expected_version_id),
                ext: Ok(value.ext),
                grace_period_end: Ok(value.grace_period_end),
                legacy_operational_until: Ok(value.legacy_operational_until),
                operational_key_type: Ok(value.operational_key_type),
                preview_id: Ok(value.preview_id),
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[
    ...
    error_codes::ALREADY_MIGRATED,
    error_codes::GRACE_PERIOD_TOO_LONG,
];
...
pub mod error_codes {
    ...
    ///
    /// A requested key type cannot serve its role, or is not in the VTA's accepted set.
    ///
    /// Declared `retryable: false`.
    ...
    /// `vta/webvh/dids/keys/migrate:alreadyMigrated`
    ///
    /// The DID already carries key roles and publishes no unassigned key.
    ///
    /// Declared `retryable: false`.
    pub const ALREADY_MIGRATED: crate::DeclaredErrorCode = crate::DeclaredErrorCode {
        code: "vta/webvh/dids/keys/migrate:alreadyMigrated",
        retryable: false,
    };
    /// `vta/webvh/dids/keys/migrate:gracePeriodTooLong`
    ///
    /// `gracePeriodEnd` is later than the latest expiry of any artefact the legacy key signed, or than the community's maximum membership period.
    ///
    /// Declared `retryable: false`.
    pub const GRACE_PERIOD_TOO_LONG: crate::DeclaredErrorCode = crate::DeclaredErrorCode {
