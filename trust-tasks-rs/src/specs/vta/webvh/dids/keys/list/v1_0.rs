...
pub struct Response {
    ...
    pub unassigned: ::std::vec::Vec<UnassignedKey>,
...
pub struct UnassignedKey {
    ...
    pub key_type: KeyType,
    #[serde(rename = "publicKeyMultibase")]
    pub public_key_multibase: UnassignedKeyPublicKeyMultibase,
    pub relationships: Vec<DidVerificationRelationship>,
    #[serde(rename = "verificationMethod")]
    pub verification_method: UnassignedKeyVerificationMethod,
}
impl UnassignedKey {
    pub fn builder() -> builder::UnassignedKey {
        Default::default()
    }
}
///`UnassignedKeyPublicKeyMultibase`
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct UnassignedKeyPublicKeyMultibase(::std::string::String);
impl ::std::ops::Deref for UnassignedKeyPublicKeyMultibase {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<UnassignedKeyPublicKeyMultibase> for ::std::string::String {
    fn from(value: UnassignedKeyPublicKeyMultibase) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for UnassignedKeyPublicKeyMultibase {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        if value.chars().count() < 1usize {
            return Err("shorter than 1 characters".into());
...
impl ::std::convert::TryFrom<&str> for UnassignedKeyPublicKeyMultibase {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for UnassignedKeyPublicKeyMultibase {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for UnassignedKeyPublicKeyMultibase {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
///`UnassignedKeyVerificationMethod`
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct UnassignedKeyVerificationMethod(::std::string::String);
impl ::std::ops::Deref for UnassignedKeyVerificationMethod {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<UnassignedKeyVerificationMethod> for ::std::string::String {
    fn from(value: UnassignedKeyVerificationMethod) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for UnassignedKeyVerificationMethod {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        if value.chars().count() < 1usize {
            return Err("shorter than 1 characters".into());
...
impl ::std::convert::TryFrom<&str> for UnassignedKeyVerificationMethod {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for UnassignedKeyVerificationMethod {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for UnassignedKeyVerificationMethod {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
pub mod builder {
    ...
    pub struct Response {
        ...
        unassigned:
            ::std::result::Result<::std::vec::Vec<super::UnassignedKey>, ::std::string::String>,
    ...
    impl ::std::default::Default for Response {
        fn default() -> Self {
            Self {
                ...
                unassigned: Err("no value supplied for unassigned".to_string()),
    ...
    impl Response {
        ...
        where
            T: ::std::convert::TryInto<::std::vec::Vec<super::UnassignedKey>>,
            T::Error: ::std::fmt::Display,
        {
    ...
    pub struct UnassignedKey {
        ...
        key_type: ::std::result::Result<super::KeyType, ::std::string::String>,
        public_key_multibase:
            ::std::result::Result<super::UnassignedKeyPublicKeyMultibase, ::std::string::String>,
        relationships:
            ::std::result::Result<Vec<super::DidVerificationRelationship>, ::std::string::String>,
        verification_method:
            ::std::result::Result<super::UnassignedKeyVerificationMethod, ::std::string::String>,
    }
    impl ::std::default::Default for UnassignedKey {
        fn default() -> Self {
            Self {
                custody: Ok(Default::default()),
                key_type: Err("no value supplied for key_type".to_string()),
    ...
    impl UnassignedKey {
        ...
        pub fn public_key_multibase<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::UnassignedKeyPublicKeyMultibase>,
            T::Error: ::std::fmt::Display,
        {
            self.public_key_multibase = value.try_into().map_err(|e| {
                format!("error converting supplied value for public_key_multibase: {e}")
        ...
        pub fn verification_method<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::UnassignedKeyVerificationMethod>,
            T::Error: ::std::fmt::Display,
        {
            self.verification_method = value.try_into().map_err(|e| {
                format!("error converting supplied value for verification_method: {e}")
    ...
    impl ::std::convert::TryFrom<UnassignedKey> for super::UnassignedKey {
        type Error = super::error::ConversionError;
        fn try_from(
            value: UnassignedKey,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
    ...
    impl ::std::convert::From<super::UnassignedKey> for UnassignedKey {
        fn from(value: super::UnassignedKey) -> Self {
            Self {
                custody: Ok(value.custody),
                key_type: Ok(value.key_type),
                public_key_multibase: Ok(value.public_key_multibase),
