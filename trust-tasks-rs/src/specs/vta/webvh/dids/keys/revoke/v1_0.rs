...
//!
//! Spec slug: `vta/webvh/dids/keys/revoke`. Version: `1.0`.
...
pub enum DidDocumentChangeOp {
    ...
    SetPreRotation,
    #[serde(rename = "setKeyRoles")]
    SetKeyRoles,
    #[serde(rename = "setGracePeriod")]
    SetGracePeriod,
}
impl ::std::fmt::Display for DidDocumentChangeOp {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            ...
            Self::SetKeyRoles => f.write_str("setKeyRoles"),
            Self::SetGracePeriod => f.write_str("setGracePeriod"),
        }
    }
}
impl ::std::str::FromStr for DidDocumentChangeOp {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            ...
            "setKeyRoles" => Ok(Self::SetKeyRoles),
            "setGracePeriod" => Ok(Self::SetGracePeriod),
...
pub enum DidDocumentPreviewWarningsItem {
    ...
    AlgorithmNotInAcceptedSet,
    #[serde(rename = "overlapShorterThanValidityPeriod")]
    OverlapShorterThanValidityPeriod,
...
impl ::std::fmt::Display for DidDocumentPreviewWarningsItem {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            ...
            Self::OverlapShorterThanValidityPeriod => {
                f.write_str("overlapShorterThanValidityPeriod")
            }
...
impl ::std::str::FromStr for DidDocumentPreviewWarningsItem {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            ...
            "overlapShorterThanValidityPeriod" => Ok(Self::OverlapShorterThanValidityPeriod),
...
///Revoke a did:webvh key for compromise: withdraw it from its role in one entry, without overlap, record the compromise time so verifiers judge its past signatures accordingly, and put a generated replacement in its place where the role would otherwise be empty.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/vta/webvh/dids/keys/revoke/1.0",
///  "title": "Payload",
///  "description": "Revoke a did:webvh key for compromise: withdraw it from its role in one entry, without overlap, record the compromise time so verifiers judge its past signatures accordingly, and put a generated replacement in its place where the role would otherwise be empty.",
///  "type": "object",
///  "required": [
///    "compromisedSince",
///    "did",
...
///  "properties": {
///    "compromisedSince": {
///      "description": "The compromise time (VTI-KEY-121): the earliest instant from which the key is to be treated as compromised. Err early. Where it cannot be established, give the time the key was first published — `keys/list` reports it. MUST NOT be later than the request's `issuedAt`.",
///      "type": "string",
///      "format": "date-time"
///    },
///    "did": {
...
///    },
///    "replacement": {
///      "description": "Generate a replacement in the same role, in the same entry. Absent means: replace only if the role would otherwise have no active key, with the revoked key's algorithm. Not permitted for `update`, whose replacement is the committed successor.",
///      "type": "object",
///      "properties": {
///        "keyType": {
///          "$ref": "#/definitions/KeyType"
...
///    },
///    "role": {
///      "description": "The role of the compromised key.",
///      "$ref": "#/definitions/KeyRole"
///    },
///    "verificationMethod": {
///      "description": "The compromised key's verification method. REQUIRED for every role but `update`, and forbidden for `update`.",
///      "type": "string",
///      "minLength": 1
///    }
///  },
...
#[non_exhaustive]
pub struct Payload {
    ///The compromise time (VTI-KEY-121): the earliest instant from which the key is to be treated as compromised. Err early. Where it cannot be established, give the time the key was first published — `keys/list` reports it. MUST NOT be later than the request's `issuedAt`.
    #[serde(rename = "compromisedSince")]
    pub compromised_since: ::chrono::DateTime<::chrono::offset::Utc>,
    ...
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub replacement: ::std::option::Option<PayloadReplacement>,
    ///The role of the compromised key.
    pub role: KeyRole,
    ///The compromised key's verification method. REQUIRED for every role but `update`, and forbidden for `update`.
    #[serde(
        rename = "verificationMethod",
        default,
        skip_serializing_if = "::std::option::Option::is_none"
    )]
    pub verification_method: ::std::option::Option<PayloadVerificationMethod>,
}
impl Payload {
...
///Generate a replacement in the same role, in the same entry. Absent means: replace only if the role would otherwise have no active key, with the revoked key's algorithm. Not permitted for `update`, whose replacement is the committed successor.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
impl ::std::default::Default for PayloadReplacement {
    fn default() -> Self {
        Self {
...
impl PayloadReplacement {
    pub fn builder() -> builder::PayloadReplacement {
        Default::default()
    }
}
///The compromised key's verification method. REQUIRED for every role but `update`, and forbidden for `update`.
...
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct PayloadVerificationMethod(::std::string::String);
impl ::std::ops::Deref for PayloadVerificationMethod {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<PayloadVerificationMethod> for ::std::string::String {
    fn from(value: PayloadVerificationMethod) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for PayloadVerificationMethod {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        if value.chars().count() < 1usize {
            return Err("shorter than 1 characters".into());
...
impl ::std::convert::TryFrom<&str> for PayloadVerificationMethod {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for PayloadVerificationMethod {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for PayloadVerificationMethod {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
///Success response. Type https://trusttasks.org/spec/vta/webvh/dids/keys/revoke/1.0#response. A refusal is a `trust-task-error` document, never this.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "title": "Response",
///  "description": "Success response. Type https://trusttasks.org/spec/vta/webvh/dids/keys/revoke/1.0#response. A refusal is a `trust-task-error` document, never this.",
///  "type": "object",
///  "required": [
///    "did",
///    "keys",
...
///    },
///    "followUp": {
///      "description": "What the node must now do that this entry cannot (VTI-KEY-133). Custody data, present for an `attestation` revocation.",
///      "type": "object",
///      "properties": {
///        "artefactsToReissue": {
///          "description": "Attestation artefacts still in force that the VTA's signing record shows the revoked key signed, which the node MUST re-issue.",
///          "type": "integer",
///          "minimum": 0.0
///        },
///        "statusListsToResign": {
///          "description": "Status lists signed by the revoked key, which the node MUST re-sign at once under a sound attestation key.",
///          "type": "integer",
///          "minimum": 0.0
///        }
///      },
...
pub struct Response {
    ...
    pub follow_up: ::std::option::Option<ResponseFollowUp>,
...
///What the node must now do that this entry cannot (VTI-KEY-133). Custody data, present for an `attestation` revocation.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
#[serde(deny_unknown_fields)]
#[non_exhaustive]
pub struct ResponseFollowUp {
    ///Attestation artefacts still in force that the VTA's signing record shows the revoked key signed, which the node MUST re-issue.
    #[serde(
        rename = "artefactsToReissue",
        default,
        skip_serializing_if = "::std::option::Option::is_none"
    )]
    pub artefacts_to_reissue: ::std::option::Option<u64>,
    ///Status lists signed by the revoked key, which the node MUST re-sign at once under a sound attestation key.
    #[serde(
        rename = "statusListsToResign",
        default,
        skip_serializing_if = "::std::option::Option::is_none"
    )]
    pub status_lists_to_resign: ::std::option::Option<u64>,
}
impl ::std::default::Default for ResponseFollowUp {
    fn default() -> Self {
        Self {
            artefacts_to_reissue: Default::default(),
            status_lists_to_resign: Default::default(),
        }
    }
}
impl ResponseFollowUp {
    pub fn builder() -> builder::ResponseFollowUp {
        Default::default()
    }
}
...
pub struct RotationRecord {
    ...
    #[serde(
        rename = "gracePeriodEnd",
        default,
        skip_serializing_if = "::std::option::Option::is_none"
    )]
    pub grace_period_end: ::std::option::Option<::chrono::DateTime<::chrono::offset::Utc>>,
...
pub mod builder {
    ...
    pub struct Payload {
        ...
        replacement: ::std::result::Result<
            ::std::option::Option<super::PayloadReplacement>,
            ::std::string::String,
        >,
        role: ::std::result::Result<super::KeyRole, ::std::string::String>,
        verification_method: ::std::result::Result<
            ::std::option::Option<super::PayloadVerificationMethod>,
            ::std::string::String,
        >,
    }
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                compromised_since: Err("no value supplied for compromised_since".to_string()),
    ...
    impl Payload {
        ...
        where
            T: ::std::convert::TryInto<::std::option::Option<super::PayloadReplacement>>,
            T::Error: ::std::fmt::Display,
        {
        ...
        pub fn verification_method<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::PayloadVerificationMethod>>,
            T::Error: ::std::fmt::Display,
        {
            self.verification_method = value.try_into().map_err(|e| {
                format!("error converting supplied value for verification_method: {e}")
    ...
    impl ::std::convert::TryFrom<PayloadReplacement> for super::PayloadReplacement {
        type Error = super::error::ConversionError;
        fn try_from(
    ...
    impl ::std::convert::From<super::PayloadReplacement> for PayloadReplacement {
        fn from(value: super::PayloadReplacement) -> Self {
            Self {
                key_type: Ok(value.key_type),
            }
        }
    ...
    pub struct Response {
        ...
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
        follow_up: ::std::result::Result<
            ::std::option::Option<super::ResponseFollowUp>,
            ::std::string::String,
        >,
    ...
    impl Response {
        ...
        pub fn follow_up<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::ResponseFollowUp>>,
            T::Error: ::std::fmt::Display,
        {
            self.follow_up = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for follow_up: {e}"));
            self
        }
    ...
    #[derive(Clone, Debug)]
    pub struct ResponseFollowUp {
        artefacts_to_reissue:
            ::std::result::Result<::std::option::Option<u64>, ::std::string::String>,
        status_lists_to_resign:
            ::std::result::Result<::std::option::Option<u64>, ::std::string::String>,
    }
    impl ::std::default::Default for ResponseFollowUp {
        fn default() -> Self {
            Self {
                artefacts_to_reissue: Ok(Default::default()),
                status_lists_to_resign: Ok(Default::default()),
            }
        }
    }
    impl ResponseFollowUp {
        pub fn artefacts_to_reissue<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<u64>>,
            T::Error: ::std::fmt::Display,
        {
            self.artefacts_to_reissue = value.try_into().map_err(|e| {
                format!("error converting supplied value for artefacts_to_reissue: {e}")
            });
            self
        }
        pub fn status_lists_to_resign<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<u64>>,
            T::Error: ::std::fmt::Display,
        {
            self.status_lists_to_resign = value.try_into().map_err(|e| {
                format!("error converting supplied value for status_lists_to_resign: {e}")
            });
            self
        }
    }
    impl ::std::convert::TryFrom<ResponseFollowUp> for super::ResponseFollowUp {
        type Error = super::error::ConversionError;
        fn try_from(
            value: ResponseFollowUp,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                artefacts_to_reissue: value.artefacts_to_reissue?,
                status_lists_to_resign: value.status_lists_to_resign?,
            })
        }
    }
    impl ::std::convert::From<super::ResponseFollowUp> for ResponseFollowUp {
        fn from(value: super::ResponseFollowUp) -> Self {
            Self {
                artefacts_to_reissue: Ok(value.artefacts_to_reissue),
                status_lists_to_resign: Ok(value.status_lists_to_resign),
            }
        }
    }
    #[derive(Clone, Debug)]
    ...
    pub struct RotationRecord {
        ...
        >,
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
        grace_period_end: ::std::result::Result<
            ::std::option::Option<::chrono::DateTime<::chrono::offset::Utc>>,
            ::std::string::String,
        >,
    ...
    impl ::std::default::Default for RotationRecord {
        fn default() -> Self {
            Self {
                ...
                ext: Ok(Default::default()),
                grace_period_end: Ok(Default::default()),
    ...
    impl RotationRecord {
        ...
        pub fn grace_period_end<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<
                ::std::option::Option<::chrono::DateTime<::chrono::offset::Utc>>,
            >,
            T::Error: ::std::fmt::Display,
        {
            self.grace_period_end = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for grace_period_end: {e}"));
            self
        }
    ...
    impl ::std::convert::From<super::RotationRecord> for RotationRecord {
        fn from(value: super::RotationRecord) -> Self {
            Self {
                ...
                ext: Ok(value.ext),
                grace_period_end: Ok(value.grace_period_end),
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[
    ...
    error_codes::COMPROMISE_TIME_IN_FUTURE,
    error_codes::NO_SOUND_SUCCESSOR,
...
pub mod error_codes {
    ...
    ///
    /// The verification method is not a published key of this DID in the stated role.
    ///
    /// Declared `retryable: false`.
    ...
    ///
    /// The DID's latest entry no longer matches `expectedVersionId` — for an update-key compromise, possibly an entry the thief appended.
    ///
    /// Declared `retryable: false`.
    ...
    ///
    /// The replacement's key type cannot serve the role, or is not in the VTA's accepted set.
    ///
    /// Declared `retryable: false`.
    ...
    ///
    /// `compromisedSince` is later than the request's `issuedAt`.
    ///
    /// Declared `retryable: false`.
    ...
    ///
    /// An update-key revocation cannot proceed: no committed successor update key remains that is not itself compromised. The identifier must be deactivated and a successor identity established (VTI-KEY-124).
    ///
    /// Declared `retryable: false`.
    ...
    ///
    /// `verificationMethod` is missing for a role that needs it, or `verificationMethod` or `replacement` was given for `role: update`.
    ///
    /// Declared `retryable: false`.
