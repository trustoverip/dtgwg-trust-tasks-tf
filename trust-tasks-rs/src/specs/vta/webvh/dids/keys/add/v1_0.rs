...
//!
//! Spec slug: `vta/webvh/dids/keys/add`. Version: `1.0`.
...
///Add a newly generated key to one role of a did:webvh, without removing any — a post-quantum key beside a classical one, or a second operational key.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/vta/webvh/dids/keys/add/1.0",
///  "title": "Payload",
///  "description": "Add a newly generated key to one role of a did:webvh, without removing any — a post-quantum key beside a classical one, or a second operational key.",
///  "type": "object",
///  "required": [
///    "did",
///    "keyType",
...
///    },
///    "keyType": {
///      "description": "Algorithm of the key to generate. Must suit the role (CONVENTIONS.md §1 item 6).",
///      "$ref": "#/definitions/KeyType"
///    },
///    "label": {
///      "description": "Operator-facing label for the key. Never published.",
///      "type": "string",
///      "maxLength": 256
///    },
///    "previewId": {
...
///    },
///    "role": {
///      "description": "The role the key joins. `update` keys are not added; they move by rotation.",
///      "type": "string",
///      "enum": [
///        "attestation",
///        "operational",
...
impl ::std::fmt::Display for PayloadRole {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            Self::Attestation => f.write_str("attestation"),
            Self::Operational => f.write_str("operational"),
...
///Success response. Type https://trusttasks.org/spec/vta/webvh/dids/keys/add/1.0#response. A refusal is a `trust-task-error` document, never this.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "title": "Response",
///  "description": "Success response. Type https://trusttasks.org/spec/vta/webvh/dids/keys/add/1.0#response. A refusal is a `trust-task-error` document, never this.",
///  "type": "object",
///  "required": [
///    "did",
///    "keys",
...
pub mod error_codes {
    ...
    ///
    /// The key type cannot serve the role, or is not in the VTA's accepted set.
    ///
    /// Declared `retryable: false`.
