...
//!
//! Spec slug: `vta/webvh/dids/keys/retire`. Version: `1.0`.
...
///Retire one key from a did:webvh by planned retirement: remove it from its role, its relationship, keyRoles and the document. Completes a rotation (retire the predecessor), aborts one (retire the successor), or removes an added key. What the key signed while published stays valid.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/vta/webvh/dids/keys/retire/1.0",
///  "title": "Payload",
///  "description": "Retire one key from a did:webvh by planned retirement: remove it from its role, its relationship, keyRoles and the document. Completes a rotation (retire the predecessor), aborts one (retire the successor), or removes an added key. What the key signed while published stays valid.",
///  "type": "object",
///  "required": [
///    "did",
///    "verificationMethod"
...
///    },
///    "role": {
///      "description": "The role the caller believes the key holds. When present the VTA MUST refuse with `vta/webvh/dids:keyNotFound` if the key is not in it — a guard against retiring the wrong key from a list that moved.",
///      "$ref": "#/definitions/KeyRole"
///    },
///    "rotationId": {
///      "description": "The rotation this retirement completes or aborts. When present, the key MUST be that rotation's predecessor (completing) or successor (aborting).",
///      "type": "string",
///      "minLength": 1
///    },
///    "verificationMethod": {
///      "description": "The full verification-method identifier of the key to retire.",
///      "type": "string",
///      "minLength": 1
///    }
///  },
...
pub struct Payload {
    ...
    ///The role the caller believes the key holds. When present the VTA MUST refuse with `vta/webvh/dids:keyNotFound` if the key is not in it — a guard against retiring the wrong key from a list that moved.
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub role: ::std::option::Option<KeyRole>,
    ///The rotation this retirement completes or aborts. When present, the key MUST be that rotation's predecessor (completing) or successor (aborting).
    #[serde(
        rename = "rotationId",
        default,
        skip_serializing_if = "::std::option::Option::is_none"
    )]
    pub rotation_id: ::std::option::Option<PayloadRotationId>,
    ///The full verification-method identifier of the key to retire.
    #[serde(rename = "verificationMethod")]
    pub verification_method: PayloadVerificationMethod,
}
impl Payload {
...
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct PayloadRotationId(::std::string::String);
impl ::std::ops::Deref for PayloadRotationId {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<PayloadRotationId> for ::std::string::String {
    fn from(value: PayloadRotationId) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for PayloadRotationId {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        if value.chars().count() < 1usize {
            return Err("shorter than 1 characters".into());
...
impl ::std::convert::TryFrom<&str> for PayloadRotationId {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for PayloadRotationId {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for PayloadRotationId {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
///Success response. Type https://trusttasks.org/spec/vta/webvh/dids/keys/retire/1.0#response. A refusal is a `trust-task-error` document, never this.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "title": "Response",
///  "description": "Success response. Type https://trusttasks.org/spec/vta/webvh/dids/keys/retire/1.0#response. A refusal is a `trust-task-error` document, never this.",
///  "type": "object",
///  "required": [
///    "did",
///    "keys",
...
pub mod builder {
    ...
    pub struct Payload {
        ...
        reason: ::std::result::Result<
            ...
            ::std::string::String,
        >,
        role: ::std::result::Result<::std::option::Option<super::KeyRole>, ::std::string::String>,
        rotation_id: ::std::result::Result<
            ::std::option::Option<super::PayloadRotationId>,
            ::std::string::String,
        >,
        verification_method:
            ::std::result::Result<super::PayloadVerificationMethod, ::std::string::String>,
    }
    ...
    impl Payload {
        ...
        pub fn role<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::KeyRole>>,
            T::Error: ::std::fmt::Display,
        {
            self.role = value
                .try_into()
        ...
        where
            T: ::std::convert::TryInto<::std::option::Option<super::PayloadRotationId>>,
            T::Error: ::std::fmt::Display,
        {
        ...
        pub fn verification_method<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::PayloadVerificationMethod>,
            T::Error: ::std::fmt::Display,
        {
            self.verification_method = value.try_into().map_err(|e| {
                format!("error converting supplied value for verification_method: {e}")
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[
    ...
    error_codes::WOULD_EMPTY_ROLE,
    error_codes::LEGACY_KEYS_PRESENT,
    error_codes::NOT_YET_ACTIVE,
];
...
pub mod error_codes {
    ...
    ///
    /// The verification method is not a published key of this DID, not in the stated role, or not part of the stated rotation.
    ///
    /// Declared `retryable: false`.
    ...
    ///
    /// The key is the role's last active key. Add or rotate in a successor first.
    ///
    /// Declared `retryable: false`.
    ...
    ///
    /// Completing the rotation would retire the predecessor before its successor has activated — before every cached document can have seen the successor.
    ///
    /// Declared `retryable: true`.
