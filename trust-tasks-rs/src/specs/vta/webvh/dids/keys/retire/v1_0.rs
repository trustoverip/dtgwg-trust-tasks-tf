...
pub mod error_codes {
    ...
    ///
    /// Completing the rotation would retire the predecessor before the rotation's cache horizon has passed and its successor has switched — before every cached document can have seen the successor.
    ///
    /// Declared `retryable: true`.
