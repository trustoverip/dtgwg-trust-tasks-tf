...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::LOCATION_TAKEN];
...
/// declared.
pub mod error_codes {
    /// `vta/webvh/dids/register-with-server:locationTaken`
    ///
    /// The hosting location already holds a different registration and force was not set.
    ///
