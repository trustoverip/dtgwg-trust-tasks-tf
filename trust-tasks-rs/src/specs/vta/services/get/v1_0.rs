...
//!
//! Spec slug: `vta/services/get`. Version: `1.0`.
...
pub mod builder {
    ...
    pub struct Response {
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
        state: ::std::result::Result<super::ServiceState, ::std::string::String>,
    }
    ...
    impl Response {
        ...
        where
            T: ::std::convert::TryInto<super::ServiceState>,
            T::Error: ::std::fmt::Display,
        {
            self.state = value
                .try_into()
...
/// declared.
pub mod error_codes {
    /// `vta/services/get:notFound`
    ///
    /// The agent has never held this transport. Distinct from holding it disabled, which returns a state with enabled:false.
    ///
