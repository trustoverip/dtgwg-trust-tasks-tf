...
pub struct Payload {
    ...
    pub drain_ttl_secs: ::std::option::Option<u64>,
...
pub mod builder {
    #[derive(Clone, Debug)]
    pub struct Payload {
        drain_ttl_secs: ::std::result::Result<::std::option::Option<u64>, ::std::string::String>,
    ...
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                drain_ttl_secs: Ok(Default::default()),
    ...
    impl Payload {
        pub fn drain_ttl_secs<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<u64>>,
            T::Error: ::std::fmt::Display,
        {
            self.drain_ttl_secs = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for drain_ttl_secs: {e}"));
            self
        }
    ...
    impl ::std::convert::TryFrom<Payload> for super::Payload {
        ...
        fn try_from(value: Payload) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                drain_ttl_secs: value.drain_ttl_secs?,
                ext: value.ext?,
    ...
    impl ::std::convert::From<super::Payload> for Payload {
        fn from(value: super::Payload) -> Self {
            Self {
                drain_ttl_secs: Ok(value.drain_ttl_secs),
                ext: Ok(value.ext),
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] =
    &[error_codes::NOT_FOUND, error_codes::NOT_AUTHORIZED];
...
/// declared.
pub mod error_codes {
    /// `vta/services/disable:notFound`
    ///
    /// No such transport is configured on this agent.
    ///
