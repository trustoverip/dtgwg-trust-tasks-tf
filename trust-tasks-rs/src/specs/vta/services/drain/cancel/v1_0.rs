...
//!
//! Spec slug: `vta/services/drain/cancel`. Version: `1.0`.
...
pub struct Payload {
    ...
    pub mediator_did: PayloadMediatorDid,
}
impl Payload {
...
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct PayloadMediatorDid(::std::string::String);
impl ::std::ops::Deref for PayloadMediatorDid {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<PayloadMediatorDid> for ::std::string::String {
    fn from(value: PayloadMediatorDid) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for PayloadMediatorDid {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl ::std::convert::TryFrom<&str> for PayloadMediatorDid {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for PayloadMediatorDid {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for PayloadMediatorDid {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
pub struct Response {
    ...
    #[serde(rename = "mediatorDid")]
    pub mediator_did: ::std::string::String,
}
impl Response {
...
pub mod builder {
    ...
    pub struct Payload {
        ...
        mediator_did: ::std::result::Result<super::PayloadMediatorDid, ::std::string::String>,
    }
    ...
    impl Payload {
        ...
        where
            T: ::std::convert::TryInto<super::PayloadMediatorDid>,
            T::Error: ::std::fmt::Display,
        {
    ...
    pub struct Response {
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
        mediator_did: ::std::result::Result<::std::string::String, ::std::string::String>,
    }
...
/// declared.
pub mod error_codes {
    /// `vta/services/drain/cancel:notFound`
    ///
    /// That mediator is not draining.
    ///
    ...
    ///
    /// That mediator is the currently advertised one; cancelling its drain would strand every route the agent depends on.
    ///
    /// Declared `retryable: false`.
