...
//!
//! Spec slug: `vta/contexts/list`. Version: `1.0`.
...
pub struct Response {
    ...
    pub contexts: ::std::vec::Vec<ContextRecord>,
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub ext: ::std::option::Option<Ext>,
}
impl Response {
...
pub mod builder {
    ...
    pub struct Response {
        contexts:
            ::std::result::Result<::std::vec::Vec<super::ContextRecord>, ::std::string::String>,
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
    }
    impl ::std::default::Default for Response {
        fn default() -> Self {
            Self {
                contexts: Err("no value supplied for contexts".to_string()),
                ext: Ok(Default::default()),
            }
        }
    }
    impl Response {
        ...
        where
            T: ::std::convert::TryInto<::std::vec::Vec<super::ContextRecord>>,
            T::Error: ::std::fmt::Display,
        {
            self.contexts = value
                .try_into()
