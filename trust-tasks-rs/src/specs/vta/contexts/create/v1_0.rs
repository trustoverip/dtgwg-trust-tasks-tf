...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::PARENT_NOT_FOUND];
...
/// declared.
pub mod error_codes {
    /// `vta/contexts/create:parentNotFound`
    ///
    /// The named parent context does not exist or is not reachable by the caller.
    ///
