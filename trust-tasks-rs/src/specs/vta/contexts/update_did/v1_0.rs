...
//!
//! Spec slug: `vta/contexts/update-did`. Version: `1.0`.
...
///Success response to vta/contexts/update-did: the context as it now stands. Type https://trusttasks.org/spec/vta/contexts/update-did/1.0#response.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
/// declared.
pub mod error_codes {
    /// `vta/contexts/update-did:notFound`
    ///
    /// No context with this id is reachable by the caller.
    ///
