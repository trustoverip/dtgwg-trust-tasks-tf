...
//!
//! Spec slug: `vta/contexts/get`. Version: `1.0`.
...
///Success response to vta/contexts/get: the context record, at the top level rather than wrapped. Type https://trusttasks.org/spec/vta/contexts/get/1.0#response.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
pub mod error_codes {
    ...
    ///
    /// No context with this id is reachable by the caller. Deliberately does not distinguish "does not exist" from "exists but not yours".
    ///
