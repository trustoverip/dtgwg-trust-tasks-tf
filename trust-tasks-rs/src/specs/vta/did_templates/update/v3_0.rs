...
//!
//! Spec slug: `vta/did-templates/update`. Version: `3.0`.
...
impl crate::Payload for Payload {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/vta/did-templates/update/3.0";
...
/// declared.
pub mod error_codes {
    /// `vta/did-templates/update:notFound`
    ///
    /// No template with this name in the selected scope to replace.
    ///
