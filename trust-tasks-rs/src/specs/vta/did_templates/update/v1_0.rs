...
//!
//! Spec slug: `vta/did-templates/update`. Version: `1.0`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/vta/did-templates/update/1.0",
///  "title": "Payload",
///  "description": "Replace an existing global DID template on a VTA. Super-admin gated. The `name` is the resource id within the global scope and MUST equal `template.name`; the VTA replaces the stored body, preserving createdAt/createdBy and advancing updatedAt. The success response is the persisted DidTemplateRecord.",
///  "type": "object",
///  "required": [
///    "name",
///    "template"
...
///    },
///    "name": {
///      "description": "Resource id — the template's name. MUST equal `template.name` or the VTA rejects with the framework's `malformedRequest`.",
///      "type": "string",
///      "minLength": 1
///    },
///    "template": {
...
///{
///  "title": "Response",
///  "description": "The persisted DidTemplateRecord. The DidTemplate fields are flattened at the top level alongside the resolved scope and provenance metadata. Same shape returned by create/get.",
///  "type": "object",
///  "required": [
///    "createdAt",
///    "createdBy",
...
pub mod error_codes {
    ...
    ///
    /// No global template with this name to replace.
    ///
