...
//!
//! Spec slug: `vta/did-templates/create`. Version: `1.0`.
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::DUPLICATE_NAME];
...
pub mod error_codes {
    ...
    ///
    /// A global template with this name already exists. Use update to replace it.
    ///
