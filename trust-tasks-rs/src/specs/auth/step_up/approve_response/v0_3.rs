...
//!
//! Spec slug: `auth/step-up/approve-response`. Version: `0.3`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/auth/step-up/approve-response/0.3",
///  "title": "Payload",
...
///{
///  "title": "Response",
///  "description": "Acknowledgement the relying party returns after processing the approval. Carried in a Trust Task document whose type is https://trusttasks.org/spec/auth/step-up/approve-response/0.3#response.",
///  "type": "object",
///  "required": [
///    "status"
///  ],
...
impl crate::Payload for Payload {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/auth/step-up/approve-response/0.3";
...
pub mod error_codes {
    ...
    ///
    /// The echoed `payload.subject` does not equal the session's subject, or the proof's verificationMethod DID does not equal the document's issuer (the signer is not the named approver).
    ///
    /// Declared `retryable: false`.
