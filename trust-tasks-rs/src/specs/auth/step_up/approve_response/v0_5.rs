...
//!
//! Spec slug: `auth/step-up/approve-response`. Version: `0.5`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/auth/step-up/approve-response/0.5",
///  "title": "Payload",
...
///Acknowledgement the relying party returns after processing the approval. Carried in a Trust Task document whose type is https://trusttasks.org/spec/auth/step-up/approve-response/0.5#response.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "title": "Response",
///  "description": "Acknowledgement the relying party returns after processing the approval. Carried in a Trust Task document whose type is https://trusttasks.org/spec/auth/step-up/approve-response/0.5#response.",
///  "type": "object",
///  "required": [
///    "status"
///  ],
...
impl crate::Payload for Payload {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/auth/step-up/approve-response/0.5";
...
pub mod error_codes {
    ...
    ///
    /// The document's `evidence.kind` is one the relying party does not recognise, or names a gate the relying party did not offer for this step-up. A missing framework proof is `proofRequired` and an invalid one `proofInvalid` (SPEC §8.3), never this code.
    ///
    /// Declared `retryable: false`.
