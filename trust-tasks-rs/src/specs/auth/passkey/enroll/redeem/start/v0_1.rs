...
//!
//! Spec slug: `auth/passkey/enroll/redeem/start`. Version: `0.1`.
...
pub struct Payload {
    ...
    pub claim_code: PayloadClaimCode,
...
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct PayloadClaimCode(::std::string::String);
impl ::std::ops::Deref for PayloadClaimCode {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<PayloadClaimCode> for ::std::string::String {
    fn from(value: PayloadClaimCode) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for PayloadClaimCode {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        if value.chars().count() > 64usize {
            return Err("longer than 64 characters".into());
...
impl ::std::convert::TryFrom<&str> for PayloadClaimCode {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for PayloadClaimCode {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for PayloadClaimCode {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct PayloadToken(::std::string::String);
impl ::std::ops::Deref for PayloadToken {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<PayloadToken> for ::std::string::String {
    fn from(value: PayloadToken) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for PayloadToken {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl ::std::convert::TryFrom<&str> for PayloadToken {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for PayloadToken {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for PayloadToken {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
pub mod builder {
    ...
    #[derive(Clone, Debug)]
    pub struct Payload {
        claim_code: ::std::result::Result<super::PayloadClaimCode, ::std::string::String>,
    ...
    impl Payload {
        ...
        where
            T: ::std::convert::TryInto<super::PayloadClaimCode>,
            T::Error: ::std::fmt::Display,
        {
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] =
    &[error_codes::INVITE_INVALID, error_codes::TOO_MANY_ATTEMPTS];
...
pub mod error_codes {
    ...
    ///
    /// The token names no redeemable invite, or the claim code is wrong, or the invite has expired or been consumed. Deliberately one code for all of these, so that redemption is no oracle for which half was wrong.
    ///
    /// Declared `retryable: false`.
    pub const INVITE_INVALID: crate::DeclaredErrorCode = crate::DeclaredErrorCode {
        code: "auth/passkey/enroll/redeem/start:inviteInvalid",
        retryable: false,
    };
    /// `auth/passkey/enroll/redeem/start:tooManyAttempts`
    ///
    /// Too many wrong claim codes were presented for this invite; it has been invalidated. Ask the administrator for a new one.
    ///
    /// Declared `retryable: false`.
    pub const TOO_MANY_ATTEMPTS: crate::DeclaredErrorCode = crate::DeclaredErrorCode {
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            (
                "Missing claimCode — the token alone never redeems an invite.",
                "{\n  \"token\": \"inv_8f2c1d4e9a7b30568f2c1d4e9a7b3056a1b2c3d4\"\n}",
            ),
            ("Missing token.", "{\n  \"claimCode\": \"7KQ4-MX2P-9TDA\"\n}"),
            (
                "Token shorter than 16 characters — too little entropy to be an invite token.",
                "{\n  \"claimCode\": \"7KQ4-MX2P-9TDA\",\n  \"token\": \"short\"\n}",
            ),
            (
                "subject in the request — the subject comes from the invite, never from the invitee.",
                "{\n  \"claimCode\": \"7KQ4-MX2P-9TDA\",\n  \"subject\": \"did:webvh:QmCarolScid3:acme-vtc.example:carol\",\n  \"token\": \"inv_8f2c1d4e9a7b30568f2c1d4e9a7b3056a1b2c3d4\"\n}",
            ),
            (
                "purpose in the request — the purpose comes from the invite, never from the invitee.",
                "{\n  \"claimCode\": \"7KQ4-MX2P-9TDA\",\n  \"purpose\": \"session\",\n  \"token\": \"inv_8f2c1d4e9a7b30568f2c1d4e9a7b3056a1b2c3d4\"\n}",
            ),
        ];
