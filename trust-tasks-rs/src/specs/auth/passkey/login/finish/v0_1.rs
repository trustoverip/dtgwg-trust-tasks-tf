...
pub struct AssertionResponse {
    ...
    pub client_extension_results: ::serde_json::Map<
        ::std::string::String,
        ::serde_json::Value,
    >,
...
for AssertionResponseAuthenticatorAttachment {
    type Error = self::error::ConversionError;
    fn try_from(
...
impl ::std::convert::From<&PayloadAuthId> for PayloadAuthId {
    fn from(value: &PayloadAuthId) -> Self {
        value.clone()
    }
}
...
impl ::std::convert::From<&Self> for ResponsePurpose {
