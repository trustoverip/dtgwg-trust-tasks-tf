...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::REFUSED];
...
/// declared.
pub mod error_codes {
    /// `witness/session:refused`
    ///
    /// The witness declines to open a session — policy, capacity, or the named exchange is not one it will witness.
    ///
