...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] =
    &[error_codes::UNKNOWN_HANDLE, error_codes::NOT_CONTROLLER];
...
pub mod error_codes {
    ...
    ///
    /// The authenticated caller is not the controller VTA recorded for this handle (at push/register). Only the controller may set the allowlist.
    ///
    /// Declared `retryable: false`.
