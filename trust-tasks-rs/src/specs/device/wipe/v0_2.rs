...
//!
//! Spec slug: `device/wipe`. Version: `0.2`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/device/wipe/0.2",
///  "title": "Payload",
...
impl ::std::fmt::Display for PayloadScope {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            ...
            Self::CacheAndKeys => f.write_str("cacheAndKeys"),
...
impl ::std::str::FromStr for PayloadScope {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            "cache" => Ok(Self::Cache),
            "cacheAndKeys" => Ok(Self::CacheAndKeys),
            "full" => Ok(Self::Full),
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] =
    &[error_codes::NOT_FOUND, error_codes::WIPE_PARTIAL];
...
/// declared.
pub mod error_codes {
    /// `device/wipe:notFound`
    ///
    /// No DeviceBinding with this id.
    ///
