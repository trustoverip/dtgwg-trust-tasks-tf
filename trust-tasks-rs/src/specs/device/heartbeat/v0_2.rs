...
//!
//! Spec slug: `device/heartbeat`. Version: `0.2`.
...
impl ::std::fmt::Display for QueuedOperationKind {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            ...
            Self::PolicyReload => f.write_str("policyReload"),
            Self::ConfigUpdate => f.write_str("configUpdate"),
        }
    }
}
impl ::std::str::FromStr for QueuedOperationKind {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            "wipe" => Ok(Self::Wipe),
            "policyReload" => Ok(Self::PolicyReload),
            "configUpdate" => Ok(Self::ConfigUpdate),
...
pub enum ResponseSyncHint {
    ...
    UpToDate,
    #[serde(rename = "syncDue")]
    SyncDue,
    #[serde(rename = "fullResyncRequired")]
    FullResyncRequired,
}
impl ::std::fmt::Display for ResponseSyncHint {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            Self::UpToDate => f.write_str("upToDate"),
            Self::SyncDue => f.write_str("syncDue"),
            Self::FullResyncRequired => f.write_str("fullResyncRequired"),
        }
    }
}
impl ::std::str::FromStr for ResponseSyncHint {
    ...
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            ...
            "syncDue" => Ok(Self::SyncDue),
            "fullResyncRequired" => Ok(Self::FullResyncRequired),
            _ => Err("invalid value".into()),
        }
    }
}
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::NOT_REGISTERED];
...
pub mod error_codes {
    ...
    ///
    /// The issuer's DID has no DeviceBinding. The consumer SHOULD complete device/register.
    ///
