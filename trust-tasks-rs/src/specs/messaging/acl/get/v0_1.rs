...
//!
//! Spec slug: `messaging/acl/get`. Version: `0.1`.
...
pub mod builder {
    ...
    impl ::std::convert::TryFrom<Entry> for super::Entry {
        type Error = super::error::ConversionError;
        fn try_from(value: Entry) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                acl: value.acl?,
                did: value.did?,
            })
    ...
    impl ::std::convert::From<super::Entry> for Entry {
    ...
    #[derive(Clone, Debug)]
    pub struct Response {
        entries: ::std::result::Result<::std::vec::Vec<super::Entry>, ::std::string::String>,
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
        unknown: ::std::result::Result<::std::vec::Vec<super::Vid>, ::std::string::String>,
    }
    ...
    impl Response {
        ...
        where
            T: ::std::convert::TryInto<::std::vec::Vec<super::Entry>>,
            T::Error: ::std::fmt::Display,
        {
            self.entries = value
                .try_into()
