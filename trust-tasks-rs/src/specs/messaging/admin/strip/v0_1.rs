...
pub mod builder {
    ...
    pub struct Response {
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
        stripped: ::std::result::Result<::std::vec::Vec<super::Vid>, ::std::string::String>,
    }
    impl ::std::default::Default for Response {
        fn default() -> Self {
            Self {
                ext: Ok(Default::default()),
                stripped: Err("no value supplied for stripped".to_string()),
            }
        }
    }
    impl Response {
        ...
        pub fn stripped<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::vec::Vec<super::Vid>>,
            T::Error: ::std::fmt::Display,
        {
            self.stripped = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for stripped: {e}"));
            self
        }
    }
