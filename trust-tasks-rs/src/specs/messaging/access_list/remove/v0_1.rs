...
//!
//! Spec slug: `messaging/access-list/remove`. Version: `0.1`.
...
/// declared.
pub mod error_codes {
    /// `messaging/access-list/remove:unknownAccount`
    ///
    ...
    ///
    /// The requester is the account's own controller and the account is not permitted to self-manage its access list (selfManageList is not set).
    ///
    /// Declared `retryable: false`.
