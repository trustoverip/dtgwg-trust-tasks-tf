...
//!
//! Spec slug: `messaging/access-list/add`. Version: `0.1`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/messaging/access-list/add/0.1",
///  "title": "Payload",
///  "type": "object",
///  "required": [
///    "did",
...
///    },
///    "entries": {
///      "description": "The DIDs to add to the account's access list. Entries already present are ignored.",
///      "type": "array",
///      "items": {
///        "$ref": "#/definitions/Vid"
///      },
...
///{
///  "title": "Response",
///  "description": "The success response to a messaging/access-list/add request. Carried in a Trust Task document whose type is https://trusttasks.org/spec/messaging/access-list/add/0.1#response.",
///  "type": "object",
///  "required": [
///    "accessListCount",
///    "added",
...
///    },
///    "added": {
///      "description": "The entries actually added (those not already present in the access list).",
///      "type": "array",
///      "items": {
///        "$ref": "#/definitions/Vid"
///      }
...
impl crate::Payload for Payload {
    ...
    const PAYLOAD_SCHEMA: Option<&'static str> = Some(
        "{\n  \"$defs\": {\n    \"Ext\": {\n      \"additionalProperties\": true,\n      \"description\": \"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\n      \"minProperties\": 1,\n      \"propertyNames\": {\n        \"pattern\": \"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"\n      },\n      \"title\": \"Ext\",\n      \"type\": \"object\"\n    },\n    \"Response\": {\n      \"$anchor\": \"response\",\n      \"additionalProperties\": false,\n      \"description\": \"The success response to a messaging/access-list/add request. Carried in a Trust Task document whose type is https://trusttasks.org/spec/messaging/access-list/add/0.1#response.\",\n      \"properties\": {\n        \"accessListCount\": {\n          \"description\": \"The resulting number of entries in the account's access list.\",\n          \"minimum\": 0,\n          \"type\": \"integer\"\n        },\n        \"added\": {\n          \"description\": \"The entries actually added (those not already present in the access list).\",\n          \"items\": {\n            \"$ref\": \"#/$defs/Vid\"\n          },\n          \"type\": \"array\"\n        },\n        \"did\": {\n          \"$ref\": \"#/$defs/Vid\",\n          \"description\": \"The account whose access list was modified.\"\n        },\n        \"ext\": {\n          \"$ref\": \"#/$defs/Ext\",\n          \"description\": \"Ecosystem-defined extension members per SPEC.md §4.5.1.\"\n        }\n      },\n      \"required\": [\n        \"did\",\n        \"added\",\n        \"accessListCount\"\n      ],\n      \"title\": \"Messaging Add to Access List — response payload\",\n      \"type\": \"object\"\n    },\n    \"Vid\": {\n      \"description\": \"A Verifiable Identifier (SPEC §4.8). For a mediator-served account this is the account's controlling DID, carried verbatim and compared by exact string equality. For privacy — and because some mediators key accounts by a one-way hash and never hold the full DID — a stable hash of the DID (e.g. its SHA-256 digest) is an equally valid value here: producer and consumer simply agree on the same opaque identifier and compare by exact string equality. The field carries whichever form the issuing mediator uses.\",\n      \"minLength\": 1,\n      \"title\": \"Vid\",\n      \"type\": \"string\"\n    }\n  },\n  \"$id\": \"https://trusttasks.org/spec/messaging/access-list/add/0.1\",\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"additionalProperties\": false,\n  \"properties\": {\n    \"did\": {\n      \"$ref\": \"#/$defs/Vid\",\n      \"description\": \"The target account's DID whose access list is being modified.\"\n    },\n    \"entries\": {\n      \"description\": \"The DIDs to add to the account's access list. Entries already present are ignored.\",\n      \"items\": {\n        \"$ref\": \"#/$defs/Vid\"\n      },\n      \"minItems\": 1,\n      \"type\": \"array\"\n    },\n    \"ext\": {\n      \"$ref\": \"#/$defs/Ext\",\n      \"description\": \"Ecosystem-defined extension members per SPEC.md §4.5.1.\"\n    }\n  },\n  \"required\": [\n    \"did\",\n    \"entries\"\n  ],\n  \"title\": \"Messaging Add to Access List — payload\",\n  \"type\": \"object\"\n}\n",
    );
}
...
/// declared.
pub mod error_codes {
    /// `messaging/access-list/add:unknownAccount`
    ///
    ...
    ///
    /// The account's access list has reached its configured maximum size; no entries were added.
    ///
    /// Declared `retryable: false`.
