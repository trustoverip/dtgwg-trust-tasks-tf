...
///  "properties": {
///    "accountType": {
///      "description": "Role filter: return only accounts holding this role. Omitted = accounts of every role. Filtering on `admin` or `rootAdmin` enumerates the mediator's administrators.",
///      "$ref": "#/definitions/AccountType"
///    },
///    "cursor": {
...
impl ::std::default::Default for Payload {
    fn default() -> Self {
        Self {
            ...
            ext: Default::default(),
            include_activity: Default::default(),
            include_stats: Default::default(),
...
pub mod builder {
    ...
    #[derive(Clone, Debug)]
    pub struct Response {
        accounts: ::std::result::Result<::std::vec::Vec<super::Account>, ::std::string::String>,
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
