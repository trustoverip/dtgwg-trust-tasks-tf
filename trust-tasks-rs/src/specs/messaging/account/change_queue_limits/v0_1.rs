...
//!
//! Spec slug: `messaging/account/change-queue-limits`. Version: `0.1`.
...
pub mod builder {
    ...
    pub struct Payload {
        ...
        queue_limits: ::std::result::Result<super::QueueLimits, ::std::string::String>,
    }
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                ...
                queue_limits: Err("no value supplied for queue_limits".to_string()),
            }
        }
    }
    impl Payload {
        ...
        pub fn queue_limits<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::QueueLimits>,
            T::Error: ::std::fmt::Display,
        {
            self.queue_limits = value
                .try_into()
