...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::ALREADY_EXISTS];
...
/// declared.
pub mod error_codes {
    /// `messaging/account/add:alreadyExists`
    ///
    /// The target DID already has an account at this mediator.
    ///
