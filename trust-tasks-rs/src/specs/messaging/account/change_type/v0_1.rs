...
//!
//! Spec slug: `messaging/account/change-type`. Version: `0.1`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/messaging/account/change-type/0.1",
///  "title": "Payload",
///  "type": "object",
///  "required": [
///    "accountType",
...
///  "properties": {
///    "accountType": {
///      "description": "The role to assign. Assigning or modifying the rootAdmin role requires the requester to be a rootAdmin.",
///      "$ref": "#/definitions/AccountType"
///    },
///    "did": {
///      "description": "The DID of the account whose role is being changed.",
///      "$ref": "#/definitions/Vid"
///    },
///    "ext": {
...
///The success response to a messaging/account/change-type request. Carried in a Trust Task document whose type is https://trusttasks.org/spec/messaging/account/change-type/0.1#response.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "title": "Response",
///  "description": "The success response to a messaging/account/change-type request. Carried in a Trust Task document whose type is https://trusttasks.org/spec/messaging/account/change-type/0.1#response.",
///  "type": "object",
///  "required": [
///    "account"
///  ],
///  "properties": {
///    "account": {
///      "description": "The full realized mediator view of the account after the role change.",
...
/// declared.
pub mod error_codes {
    /// `messaging/account/change-type:unknownAccount`
    ///
    ...
    ///
    /// Assigning or modifying the rootAdmin role requires the requester to be a rootAdmin.
    ///
    /// Declared `retryable: false`.
