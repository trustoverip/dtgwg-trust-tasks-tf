...
//!
//! Spec slug: `git-ns/right/revoke`. Version: `0.3`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/git-ns/right/revoke/0.3",
///  "title": "Payload",
...
impl crate::Payload for Payload {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/git-ns/right/revoke/0.3";
...
impl crate::Payload for Response {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/git-ns/right/revoke/0.3#response";
    const IS_PROOF_REQUIRED: bool = true;
    const IS_ISSUED_AT_REQUIRED: bool = true;
    const IS_RECIPIENT_REQUIRED: bool = true;
    const PAYLOAD_SCHEMA: Option<&'static str> = Some(
