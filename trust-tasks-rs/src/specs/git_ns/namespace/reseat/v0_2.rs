...
//!
//! Spec slug: `git-ns/namespace/reseat`. Version: `0.2`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/git-ns/namespace/reseat/0.2",
///  "title": "Payload",
...
impl crate::Payload for Payload {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/git-ns/namespace/reseat/0.2";
