...
//!
//! Spec slug: `git-ns/bridge/event`. Version: `0.3`.
...
///        },
///        "repos": {
///          "description": "Repositories whose own map differs from `roleMap`, each at most once. Absent or empty: every repository uses `roleMap`.",
///          "type": "array",
///          "items": {
///            "type": "object",
///            "required": [
...
///        },
///        "stale": {
///          "description": "Repositories whose forge roles the bridge last projected under a different map from the one it now applies to them. Absent or empty: none.",
///          "type": "array",
///          "items": {
///            "$ref": "#/definitions/RepoResource"
///          },
...
pub enum ForgeEvent {
    ...
    RoleMapReported {
        ...
        repos: ::std::vec::Vec<ForgeEventReposItem>,
        #[serde(rename = "roleMap")]
        role_map: RoleMap,
        ...
        #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
        stale: ::std::option::Option<Vec<RepoResource>>,
    },
}
///`ForgeEventKind`
///
...
#[serde(deny_unknown_fields)]
#[non_exhaustive]
pub struct ForgeEventReposItem {
    pub resource: RepoResource,
    #[serde(rename = "roleMap")]
    pub role_map: RoleMap,
}
impl ForgeEventReposItem {
    pub fn builder() -> builder::ForgeEventReposItem {
        Default::default()
    }
}
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/git-ns/bridge/event/0.3",
///  "title": "Payload",
///  "description": "The bridge tells the VTC something happened on the forge — translated from the forge's webhook or found by an inspection sweep — together with any drift it now sees; or reports the role map it projects with.",
///  "type": "object",
///  "required": [
///    "event",
///    "namespace"
...
pub mod builder {
    ...
    pub struct ForgeEventReposItem {
        resource: ::std::result::Result<super::RepoResource, ::std::string::String>,
        role_map: ::std::result::Result<super::RoleMap, ::std::string::String>,
    }
    impl ::std::default::Default for ForgeEventReposItem {
        fn default() -> Self {
            Self {
                resource: Err("no value supplied for resource".to_string()),
                role_map: Err("no value supplied for role_map".to_string()),
            }
        }
    }
    impl ForgeEventReposItem {
        ...
        where
            T: ::std::convert::TryInto<super::RoleMap>,
            T::Error: ::std::fmt::Display,
        {
            self.role_map = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<ForgeEventReposItem> for super::ForgeEventReposItem {
        type Error = super::error::ConversionError;
        fn try_from(
            value: ForgeEventReposItem,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                resource: value.resource?,
    ...
    impl ::std::convert::From<super::ForgeEventReposItem> for ForgeEventReposItem {
        fn from(value: super::ForgeEventReposItem) -> Self {
            Self {
                resource: Ok(value.resource),
...
impl crate::Payload for Payload {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/git-ns/bridge/event/0.3";
...
impl crate::Payload for Response {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/git-ns/bridge/event/0.3#response";
    const IS_PROOF_REQUIRED: bool = true;
    const IS_ISSUED_AT_REQUIRED: bool = true;
    const IS_RECIPIENT_REQUIRED: bool = true;
    const PAYLOAD_SCHEMA: Option<&'static str> = Some(
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            ...
            (
                "A role-map report carries the map.",
                "{\n  \"event\": {\n    \"type\": \"roleMapReported\"\n  },\n  \"namespace\": \"ns_1\"\n}",
            ),
            (
                "A role-map report names the ladder its map is rounded onto.",
                "{\n  \"event\": {\n    \"roleMap\": {\n      \"commit\": \"none\",\n      \"maintain\": \"maintain\",\n      \"own\": \"admin\"\n    },\n    \"type\": \"roleMapReported\"\n  },\n  \"namespace\": \"ns_1\"\n}",
            ),
            (
                "A ladder lists each level once.",
                "{\n  \"event\": {\n    \"ladder\": [\n      \"write\",\n      \"write\"\n    ],\n    \"roleMap\": {\n      \"commit\": \"none\",\n      \"maintain\": \"maintain\",\n      \"own\": \"admin\"\n    },\n    \"type\": \"roleMapReported\"\n  },\n  \"namespace\": \"ns_1\"\n}",
            ),
            (
                "A ladder lists at least one level.",
                "{\n  \"event\": {\n    \"ladder\": [],\n    \"roleMap\": {\n      \"commit\": \"none\",\n      \"maintain\": \"none\",\n      \"own\": \"none\"\n    },\n    \"type\": \"roleMapReported\"\n  },\n  \"namespace\": \"ns_1\"\n}",
            ),
            (
                "A role map has no member for `git.ns.admin`: a namespace admin projects to no forge role, whatever a bridge is configured with.",
                "{\n  \"event\": {\n    \"ladder\": [\n      \"read\",\n      \"triage\",\n      \"write\",\n      \"maintain\",\n      \"admin\"\n    ],\n    \"roleMap\": {\n      \"commit\": \"none\",\n      \"maintain\": \"maintain\",\n      \"nsAdmin\": \"admin\",\n      \"own\": \"admin\"\n    },\n    \"type\": \"roleMapReported\"\n  },\n  \"namespace\": \"ns_1\"\n}",
            ),
            (
                "A role map names all three rights.",
                "{\n  \"event\": {\n    \"ladder\": [\n      \"read\",\n      \"triage\",\n      \"write\",\n      \"maintain\",\n      \"admin\"\n    ],\n    \"roleMap\": {\n      \"maintain\": \"maintain\",\n      \"own\": \"admin\"\n    },\n    \"type\": \"roleMapReported\"\n  },\n  \"namespace\": \"ns_1\"\n}",
            ),
            (
                "Roles are levels of the bridge's forge-neutral ladder, not a forge's own names.",
                "{\n  \"event\": {\n    \"ladder\": [\n      \"read\",\n      \"triage\",\n      \"write\",\n      \"maintain\",\n      \"admin\"\n    ],\n    \"roleMap\": {\n      \"commit\": \"none\",\n      \"maintain\": \"maintain\",\n      \"own\": \"owner\"\n    },\n    \"type\": \"roleMapReported\"\n  },\n  \"namespace\": \"ns_1\"\n}",
            ),
            (
                "A per-repository map names one repository, not a namespace.",
                "{\n  \"event\": {\n    \"ladder\": [\n      \"read\",\n      \"triage\",\n      \"write\",\n      \"maintain\",\n      \"admin\"\n    ],\n    \"repos\": [\n      {\n        \"resource\": \"github.com/acme\",\n        \"roleMap\": {\n          \"commit\": \"none\",\n          \"maintain\": \"maintain\",\n          \"own\": \"admin\"\n        }\n      }\n    ],\n    \"roleMap\": {\n      \"commit\": \"none\",\n      \"maintain\": \"maintain\",\n      \"own\": \"admin\"\n    },\n    \"type\": \"roleMapReported\"\n  },\n  \"namespace\": \"ns_1\"\n}",
            ),
            (
                "`stale` lists each repository once.",
