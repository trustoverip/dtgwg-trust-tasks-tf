...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::NOT_AUTHORIZED];
...
/// declared.
pub mod error_codes {
    /// `consent/approver-list:notAuthorized`
    ///
    /// The issuer may not read approver bindings for the requested platform/context.
    ///
