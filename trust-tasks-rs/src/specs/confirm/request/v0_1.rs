...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] =
    &[error_codes::SUBJECT_UNKNOWN, error_codes::RATE_LIMITED];
...
/// declared.
pub mod error_codes {
    /// `confirm/request:subject_unknown`
    ///
    ...
    ///
    /// The relying party has exceeded the approver's confirm-request budget.
    ///
