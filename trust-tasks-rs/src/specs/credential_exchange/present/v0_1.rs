...
//!
//! Spec slug: `credential-exchange/present`. Version: `0.1`.
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            ...
            (
                "`vp_token` must be a string or an object, not an array.",
                "{\n  \"vp_token\": [\n    \"a\",\n    \"b\"\n  ]\n}",
            ),
            ("`vp_token` must not be a number.", "{\n  \"vp_token\": 42\n}"),
            (
                "Unknown top-level member is rejected (additionalProperties: false).",
                "{\n  \"__notARealMember__\": true,\n  \"vp_token\": \"<jws>~<disclosure>~<kb-jwt>\"\n}",
            ),
        ];
