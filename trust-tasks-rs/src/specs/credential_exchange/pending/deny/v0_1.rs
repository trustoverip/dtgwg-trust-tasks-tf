...
//!
//! Spec slug: `credential-exchange/pending/deny`. Version: `0.1`.
...
/// declared.
pub mod error_codes {
    /// `credential-exchange/pending/deny:notFound`
    ///
    /// No actionable deferral matches `id`.
    ///
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            ...
            (
                "Unknown top-level member is rejected — a denial carries no reason field to leak back to the verifier.",
                "{\n  \"id\": \"thid-123\",\n  \"reason\": \"not today\"\n}",
            ),
