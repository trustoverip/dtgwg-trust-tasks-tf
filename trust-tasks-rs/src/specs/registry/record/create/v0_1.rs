...
//!
//! Spec slug: `registry/record/create`. Version: `0.1`.
...
/// declared.
pub mod error_codes {
    /// `registry/record/create:already_exists`
    ///
    /// A record already exists for the given entity+authority+action+resource key.
    ///
