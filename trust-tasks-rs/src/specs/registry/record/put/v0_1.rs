...
pub mod builder {
    ...
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                expected_existing: Ok(Default::default()),
    ...
    impl Payload {
        pub fn expected_existing<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<bool>>,
            T::Error: ::std::fmt::Display,
        {
            self.expected_existing = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for expected_existing: {e}"));
            self
        }
    ...
    impl ::std::convert::TryFrom<Payload> for super::Payload {
        ...
        fn try_from(value: Payload) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                expected_existing: value.expected_existing?,
                ext: value.ext?,
                record: value.record?,
            })
        }
    ...
    impl ::std::convert::From<super::Payload> for Payload {
        fn from(value: super::Payload) -> Self {
            Self {
                expected_existing: Ok(value.expected_existing),
                ext: Ok(value.ext),
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] =
    &[error_codes::ALREADY_EXISTS, error_codes::NOT_FOUND];
...
/// declared.
pub mod error_codes {
    /// `registry/record/put:alreadyExists`
    ///
    /// `expectedExisting: false` was asserted but a record already exists for the given entity+authority+action+resource key.
    ///
    ...
    ///
    /// `expectedExisting: true` was asserted but no record exists for the given entity+authority+action+resource key.
    ///
    /// Declared `retryable: false`.
