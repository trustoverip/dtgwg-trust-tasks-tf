...
//!
//! Spec slug: `did-management/registry/deregister`. Version: `0.1`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/did-management/registry/deregister/0.1",
///  "title": "Payload",
///  "type": "object",
///  "required": [
///    "instanceId"
...
impl crate::Payload for Payload {
    ...
    const PAYLOAD_SCHEMA: Option<&'static str> = Some(
        "{\n  \"$defs\": {\n    \"Ext\": {\n      \"additionalProperties\": true,\n      \"description\": \"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\n      \"minProperties\": 1,\n      \"propertyNames\": {\n        \"pattern\": \"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"\n      },\n      \"title\": \"Ext\",\n      \"type\": \"object\"\n    },\n    \"Response\": {\n      \"$anchor\": \"response\",\n      \"additionalProperties\": false,\n      \"properties\": {\n        \"ext\": {\n          \"$ref\": \"#/$defs/Ext\"\n        },\n        \"instanceId\": {\n          \"type\": \"string\"\n        },\n        \"removedAt\": {\n          \"format\": \"date-time\",\n          \"type\": \"string\"\n        }\n      },\n      \"required\": [\n        \"instanceId\",\n        \"removedAt\"\n      ],\n      \"title\": \"Registry Deregister — response payload\",\n      \"type\": \"object\"\n    }\n  },\n  \"$id\": \"https://trusttasks.org/spec/did-management/registry/deregister/0.1\",\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"additionalProperties\": false,\n  \"properties\": {\n    \"ext\": {\n      \"$ref\": \"#/$defs/Ext\"\n    },\n    \"instanceId\": {\n      \"minLength\": 1,\n      \"type\": \"string\"\n    }\n  },\n  \"required\": [\n    \"instanceId\"\n  ],\n  \"title\": \"Registry Deregister — payload\",\n  \"type\": \"object\"\n}\n",
    );
}
...
/// declared.
pub mod error_codes {
    /// `did-management/registry/deregister:notFound`
    ///
    /// No registry entry matches the submitted `instanceId`.
    ///
