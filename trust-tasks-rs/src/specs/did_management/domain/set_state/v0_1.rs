...
//!
//! Spec slug: `did-management/domain/set-state`. Version: `0.1`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/did-management/domain/set-state/0.1",
///  "title": "Payload",
///  "type": "object",
///  "required": [
///    "name",
...
///    },
///    "name": {
///      "description": "The hosting domain whose state is being set.",
///      "type": "string",
///      "minLength": 1
///    },
///    "state": {
///      "description": "Desired domain state. `active`: the domain is in active service and accepts new DID registrations (re-activating a disabled domain cancels any pending purge). `disabled`: existing DIDs remain readable for the host's grace period, but no new DIDs may be hosted under it. Declarative — requesting the state the domain is already in is an idempotent no-op.",
///      "type": "string",
///      "enum": [
///        "active",
///        "disabled"
...
impl ::std::fmt::Display for PayloadState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            Self::Active => f.write_str("active"),
            Self::Disabled => f.write_str("disabled"),
...
impl ::std::str::FromStr for PayloadState {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            "active" => Ok(Self::Active),
...
impl ::std::convert::TryFrom<&str> for PayloadState {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for PayloadState {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
pub mod builder {
    ...
    pub struct Payload {
        ...
        state: ::std::result::Result<super::PayloadState, ::std::string::String>,
    }
    ...
    impl Payload {
        ...
        where
            T: ::std::convert::TryInto<super::PayloadState>,
            T::Error: ::std::fmt::Display,
        {
            self.state = value
                .try_into()
...
impl crate::Payload for Payload {
    ...
    const PAYLOAD_SCHEMA: Option<&'static str> = Some(
        "{\n  \"$defs\": {\n    \"DomainEntry\": {\n      \"additionalProperties\": false,\n      \"properties\": {\n        \"createdAt\": {\n          \"format\": \"date-time\",\n          \"type\": \"string\"\n        },\n        \"defaultDomain\": {\n          \"description\": \"When `true`, this domain is the host's default — new DIDs created without an explicit domain are hosted here. Exactly one entry SHOULD carry `defaultDomain: true`.\",\n          \"type\": \"boolean\"\n        },\n        \"disabledAt\": {\n          \"description\": \"Present iff `status === \\\"disabled\\\"`.\",\n          \"format\": \"date-time\",\n          \"type\": \"string\"\n        },\n        \"ext\": {\n          \"$ref\": \"#/$defs/Ext\",\n          \"description\": \"Ecosystem-defined extension members per SPEC.md §4.5.1.\"\n        },\n        \"label\": {\n          \"description\": \"Optional human-readable label.\",\n          \"type\": \"string\"\n        },\n        \"name\": {\n          \"description\": \"Hosting domain name (e.g. `did.example.com`). Compared case-insensitively; producers SHOULD emit lowercase canonical form.\",\n          \"type\": \"string\"\n        },\n        \"purgeAt\": {\n          \"description\": \"Earliest RFC3339 timestamp at which the host's background sweep is allowed to purge content for a disabled domain. Operators with administrative authority MAY override the wait via `domain/purge`.\",\n          \"format\": \"date-time\",\n          \"type\": \"string\"\n        },\n        \"status\": {\n          \"description\": \"Domain lifecycle state. A `disabled` domain still serves existing DIDs in read-only mode for the host's configured grace period before purge becomes eligible.\",\n          \"enum\": [\n            \"active\",\n            \"disabled\"\n          ],\n          \"type\": \"string\"\n        }\n      },\n      \"required\": [\n        \"name\",\n        \"status\",\n        \"createdAt\"\n      ],\n      \"title\": \"DomainEntry\",\n      \"type\": \"object\"\n    },\n    \"Ext\": {\n      \"additionalProperties\": true,\n      \"description\": \"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\n      \"minProperties\": 1,\n      \"propertyNames\": {\n        \"pattern\": \"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"\n      },\n      \"title\": \"Ext\",\n      \"type\": \"object\"\n    },\n    \"Response\": {\n      \"$anchor\": \"response\",\n      \"additionalProperties\": false,\n      \"properties\": {\n        \"entry\": {\n          \"$ref\": \"#/$defs/DomainEntry\"\n        },\n        \"ext\": {\n          \"$ref\": \"#/$defs/Ext\"\n        }\n      },\n      \"required\": [\n        \"entry\"\n      ],\n      \"title\": \"Domain Set State — response payload\",\n      \"type\": \"object\"\n    }\n  },\n  \"$id\": \"https://trusttasks.org/spec/did-management/domain/set-state/0.1\",\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"additionalProperties\": false,\n  \"properties\": {\n    \"ext\": {\n      \"$ref\": \"#/$defs/Ext\"\n    },\n    \"name\": {\n      \"description\": \"The hosting domain whose state is being set.\",\n      \"minLength\": 1,\n      \"type\": \"string\"\n    },\n    \"state\": {\n      \"description\": \"Desired domain state. `active`: the domain is in active service and accepts new DID registrations (re-activating a disabled domain cancels any pending purge). `disabled`: existing DIDs remain readable for the host's grace period, but no new DIDs may be hosted under it. Declarative — requesting the state the domain is already in is an idempotent no-op.\",\n      \"enum\": [\n        \"active\",\n        \"disabled\"\n      ],\n      \"type\": \"string\"\n    }\n  },\n  \"required\": [\n    \"name\",\n    \"state\"\n  ],\n  \"title\": \"Domain Set State — payload\",\n  \"type\": \"object\"\n}\n",
    );
}
