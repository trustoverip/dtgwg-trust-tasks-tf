...
//!
//! Spec slug: `did-management/domain/create`. Version: `0.1`.
...
pub mod builder {
    ...
    pub struct Payload {
        ...
        set_as_default: ::std::result::Result<bool, ::std::string::String>,
    }
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                ...
                label: Ok(Default::default()),
                name: Err("no value supplied for name".to_string()),
                set_as_default: Ok(Default::default()),
            }
        }
    }
    impl Payload {
        ...
        pub fn set_as_default<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<bool>,
            T::Error: ::std::fmt::Display,
        {
            self.set_as_default = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for set_as_default: {e}"));
            self
        }
    }
    impl ::std::convert::TryFrom<Payload> for super::Payload {
        ...
        fn try_from(value: Payload) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                ...
                label: value.label?,
                name: value.name?,
                set_as_default: value.set_as_default?,
            })
        }
    }
    impl ::std::convert::From<super::Payload> for Payload {
        fn from(value: super::Payload) -> Self {
            Self {
                ...
                label: Ok(value.label),
                name: Ok(value.name),
                set_as_default: Ok(value.set_as_default),
            }
        }
    }
    #[derive(Clone, Debug)]
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] =
    &[error_codes::DOMAIN_EXISTS, error_codes::INVALID_NAME];
...
pub mod error_codes {
    ...
    ///
    /// The submitted `name` violates the host's hostname grammar.
    ///
    /// Declared `retryable: false`.
