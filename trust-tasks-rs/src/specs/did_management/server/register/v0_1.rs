...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::FORBIDDEN];
...
/// declared.
pub mod error_codes {
    /// `did-management/server/register:forbidden`
    ///
    /// Caller does not hold the `Service` role on this control plane.
    ///
