...
//!
//! Spec slug: `did-management/did/disable`. Version: `0.1`.
...
/// declared.
pub mod error_codes {
    /// `did-management/did/disable:not_owner`
    ///
    ...
    /// `did-management/did/disable:already_disabled`
    ///
    /// The slot is already in the disabled state.
    ///
    /// Declared `retryable: false`.
