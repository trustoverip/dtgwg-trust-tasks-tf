...
pub mod builder {
    ...
    pub struct Payload {
        ...
        target_version: ::std::result::Result<::std::num::NonZeroU64, ::std::string::String>,
    }
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                ...
                ext: Ok(Default::default()),
                mnemonic: Err("no value supplied for mnemonic".to_string()),
                target_version: Err("no value supplied for target_version".to_string()),
            }
        }
    }
    impl Payload {
        ...
        pub fn target_version<T>(mut self, value: T) -> Self
        where
            ...
            T::Error: ::std::fmt::Display,
        {
            self.target_version = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for target_version: {e}"));
            self
        }
    }
    ...
    impl ::std::convert::From<super::Payload> for Payload {
        fn from(value: super::Payload) -> Self {
            Self {
                ...
                ext: Ok(value.ext),
                mnemonic: Ok(value.mnemonic),
                target_version: Ok(value.target_version),
            }
        }
    }
    #[derive(Clone, Debug)]
    pub struct Response {
        ...
        removed_versions: ::std::result::Result<u64, ::std::string::String>,
    }
    impl ::std::default::Default for Response {
        fn default() -> Self {
            Self {
                ...
                removed_versions: Err("no value supplied for removed_versions".to_string()),
            }
        }
    }
    impl Response {
        ...
        pub fn removed_versions<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<u64>,
            T::Error: ::std::fmt::Display,
        {
            self.removed_versions = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for removed_versions: {e}"));
            self
        }
    }
    impl ::std::convert::TryFrom<Response> for super::Response {
        ...
        fn try_from(value: Response) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                ext: value.ext?,
                record: value.record?,
                removed_versions: value.removed_versions?,
            })
        }
    }
    impl ::std::convert::From<super::Response> for Response {
        fn from(value: super::Response) -> Self {
            Self {
                ...
                removed_versions: Ok(value.removed_versions),
            }
        }
    }
}
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[
    ...
    error_codes::INVALID_TARGET_VERSION,
...
/// declared.
pub mod error_codes {
    /// `did-management/did/rollback:notOwner`
    ///
    /// The caller is not the slot's owner or an admin.
    ///
    ...
    ///
    /// The submitted `targetVersion` is greater than the current `versionCount` or less than 1.
    ///
    /// Declared `retryable: false`.
