...
//!
//! Spec slug: `did-management/did/register`. Version: `0.1`.
...
///The success response carries the canonical DidRecord the hosting service now holds for the slot.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
pub mod builder {
    ...
    pub struct Payload {
        ...
        path: ::std::result::Result<super::PayloadPath, ::std::string::String>,
    }
    ...
    impl Payload {
        ...
        where
            T: ::std::convert::TryInto<super::PayloadPath>,
            T::Error: ::std::fmt::Display,
        {
            self.path = value
                .try_into()
