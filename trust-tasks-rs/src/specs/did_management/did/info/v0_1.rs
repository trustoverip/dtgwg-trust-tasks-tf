...
//!
//! Spec slug: `did-management/did/info`. Version: `0.1`.
...
impl ::std::default::Default for ResponseLogSummary {
    fn default() -> Self {
        Self {
            latest_version_id: Default::default(),
            latest_version_time: Default::default(),
        }
    }
}
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] =
    &[error_codes::NOT_FOUND, error_codes::UNKNOWN_DOMAIN];
...
/// declared.
pub mod error_codes {
    /// `did-management/did/info:notFound`
    ///
    /// No record exists for the requested mnemonic.
    ///
