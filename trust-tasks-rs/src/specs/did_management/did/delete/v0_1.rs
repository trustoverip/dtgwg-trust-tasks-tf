...
//!
//! Spec slug: `did-management/did/delete`. Version: `0.1`.
...
pub mod error_codes {
    ...
    ///
    /// The caller is not the slot's current owner (and is not an admin).
    ///
    ...
    ///
    /// The slot is already in the deleted state.
    ///
    /// Declared `retryable: false`.
