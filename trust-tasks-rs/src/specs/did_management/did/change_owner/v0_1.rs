...
//!
//! Spec slug: `did-management/did/change-owner`. Version: `0.1`.
...
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct PayloadNewOwner(::std::string::String);
impl ::std::ops::Deref for PayloadNewOwner {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<PayloadNewOwner> for ::std::string::String {
    fn from(value: PayloadNewOwner) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for PayloadNewOwner {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        if value.chars().count() < 1usize {
            return Err("shorter than 1 characters".into());
...
impl ::std::convert::TryFrom<&str> for PayloadNewOwner {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for PayloadNewOwner {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for PayloadNewOwner {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
pub mod builder {
    ...
    pub struct Payload {
        ...
        new_owner: ::std::result::Result<super::PayloadNewOwner, ::std::string::String>,
    }
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                ...
                ext: Ok(Default::default()),
                mnemonic: Err("no value supplied for mnemonic".to_string()),
                new_owner: Err("no value supplied for new_owner".to_string()),
            }
        }
    }
    impl Payload {
        ...
        pub fn new_owner<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::PayloadNewOwner>,
            T::Error: ::std::fmt::Display,
        {
            self.new_owner = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for new_owner: {e}"));
            self
        }
    }
