...
//!
//! Spec slug: `keys/create`. Version: `0.1`.
...
pub struct Payload {
    ...
    pub key_id: ::std::option::Option<PayloadKeyId>,
...
pub mod builder {
    ...
    pub struct Payload {
        ...
        key_id: ::std::result::Result<
            ::std::option::Option<super::PayloadKeyId>,
            ::std::string::String,
        >,
        key_type: ::std::result::Result<super::KeyType, ::std::string::String>,
        label: ::std::result::Result<
    ...
    impl Payload {
        ...
        pub fn key_id<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::PayloadKeyId>>,
            T::Error: ::std::fmt::Display,
        {
            self.key_id = value
                .try_into()
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] =
    &[error_codes::ALREADY_EXISTS, error_codes::INVALID_ARGUMENT];
...
pub mod error_codes {
    /// `keys:alreadyExists`
    ///
    /// A key record already carries the target identifier; the custodian refuses rather than overwrite it. See [category conventions](../../_shared/0.1/CONVENTIONS.md#1-family-error-codes).
    ///
