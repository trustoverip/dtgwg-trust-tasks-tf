...
pub struct CapabilityManifest {
    ...
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub title: ::std::option::Option<CapabilityManifestTitle>,
...
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct CapabilityManifestTitle(::std::string::String);
impl ::std::ops::Deref for CapabilityManifestTitle {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<CapabilityManifestTitle> for ::std::string::String {
    fn from(value: CapabilityManifestTitle) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for CapabilityManifestTitle {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl ::std::convert::TryFrom<&str> for CapabilityManifestTitle {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for CapabilityManifestTitle {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for CapabilityManifestTitle {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
pub mod builder {
    ...
    pub struct CapabilityManifest {
        ...
        title: ::std::result::Result<
            ::std::option::Option<super::CapabilityManifestTitle>,
            ::std::string::String,
        >,
    ...
    impl CapabilityManifest {
        ...
        where
            T: ::std::convert::TryInto<::std::option::Option<super::CapabilityManifestTitle>>,
            T::Error: ::std::fmt::Display,
        {
            self.title = value
                .try_into()
