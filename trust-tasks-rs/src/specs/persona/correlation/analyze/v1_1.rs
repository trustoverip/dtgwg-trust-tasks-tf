...
//!
//! Spec slug: `persona/correlation/analyze`. Version: `1.1`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/persona/correlation/analyze/1.1",
///  "title": "Payload",
...
///          },
///          "crossesWorlds": {
///            "description": "Whether this linkage spans two or more of the holder's worlds — parts of their life they have said belong apart. **A second axis, not a restatement of `severity`.** `severity` says how strongly a disclosure would link the holder, which is a fact about provenance and proof rung and is true whatever the holder intended; this says whether the holder would mind. A value shared between two profiles in the SAME world is linkage the holder arranged on purpose — a work email in every work profile — and a consumer that alarmed on it teaches people to dismiss the alarm. A value shared ACROSS worlds is the finding worth raising. True only when two or more DISTINCT worlds appear among `sharedWith`: a profile belonging to no world is unarranged, not a second world, and contributes nothing here. Absent when the maintainer does not implement worlds.",
///            "type": "boolean"
///          },
///          "remedies": {
...
///                },
///                "worldId": {
///                  "description": "The world the profile at this location belongs to. Absent where it belongs to none, which is a real and common state rather than a gap — most profiles are unarranged until someone arranges them, and a consumer MUST NOT read absence as a world of its own.",
///                  "$ref": "#/definitions/Ulid"
///                }
///              },
///              "additionalProperties": false
...
pub struct ResponseFindingsItem {
    ...
    pub attribute_id: ::std::option::Option<Ulid>,
    ///Whether this linkage spans two or more of the holder's worlds — parts of their life they have said belong apart. **A second axis, not a restatement of `severity`.** `severity` says how strongly a disclosure would link the holder, which is a fact about provenance and proof rung and is true whatever the holder intended; this says whether the holder would mind. A value shared between two profiles in the SAME world is linkage the holder arranged on purpose — a work email in every work profile — and a consumer that alarmed on it teaches people to dismiss the alarm. A value shared ACROSS worlds is the finding worth raising. True only when two or more DISTINCT worlds appear among `sharedWith`: a profile belonging to no world is unarranged, not a second world, and contributes nothing here. Absent when the maintainer does not implement worlds.
    #[serde(
        rename = "crossesWorlds",
        default,
        skip_serializing_if = "::std::option::Option::is_none"
    )]
    pub crosses_worlds: ::std::option::Option<bool>,
    ...
    pub world_ids: ::std::option::Option<Vec<Ulid>>,
}
...
pub struct ResponseFindingsItemSharedWithItem {
    ...
    pub profile_id: ::std::option::Option<Ulid>,
    ///The world the profile at this location belongs to. Absent where it belongs to none, which is a real and common state rather than a gap — most profiles are unarranged until someone arranges them, and a consumer MUST NOT read absence as a world of its own.
    #[serde(
        rename = "worldId",
        default,
        skip_serializing_if = "::std::option::Option::is_none"
...
pub mod builder {
    ...
    pub struct ResponseFindingsItem {
        attribute_id:
            ::std::result::Result<::std::option::Option<super::Ulid>, ::std::string::String>,
        crosses_worlds: ::std::result::Result<::std::option::Option<bool>, ::std::string::String>,
    ...
    impl ::std::default::Default for ResponseFindingsItem {
        fn default() -> Self {
            Self {
                attribute_id: Ok(Default::default()),
                crosses_worlds: Ok(Default::default()),
    ...
    impl ResponseFindingsItem {
        ...
        pub fn crosses_worlds<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<bool>>,
            T::Error: ::std::fmt::Display,
        {
            self.crosses_worlds = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for crosses_worlds: {e}"));
            self
        }
        ...
        pub fn world_ids<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<Vec<super::Ulid>>>,
            T::Error: ::std::fmt::Display,
        {
            self.world_ids = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for world_ids: {e}"));
            self
        }
    }
    impl ::std::convert::TryFrom<ResponseFindingsItem> for super::ResponseFindingsItem {
        ...
        fn try_from(
            ...
            Ok(Self {
                attribute_id: value.attribute_id?,
                crosses_worlds: value.crosses_worlds?,
                remedies: value.remedies?,
                severity: value.severity?,
                shared_with: value.shared_with?,
                why: value.why?,
                world_ids: value.world_ids?,
            })
        }
    }
...
impl crate::Payload for Payload {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/persona/correlation/analyze/1.1";
