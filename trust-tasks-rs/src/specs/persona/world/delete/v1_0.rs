...
//!
//! Spec slug: `persona/world/delete`. Version: `1.0`.
...
///Delete one world. The faces and attributes that belonged to it are untouched — a world is a way of arranging what the holder keeps, never a container for it.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/persona/world/delete/1.0",
///  "title": "Payload",
///  "description": "Delete one world. The faces and attributes that belonged to it are untouched — a world is a way of arranging what the holder keeps, never a container for it.",
///  "type": "object",
///  "required": [
///    "worldId"
///  ],
///  "properties": {
///    "expectedVersion": {
///      "description": "Optional precondition. Supply the version a prior read returned to refuse a delete against a world that has changed since it was looked at.",
...
#[non_exhaustive]
pub struct Payload {
    ///Optional precondition. Supply the version a prior read returned to refuse a delete against a world that has changed since it was looked at.
    #[serde(
...
///Success response to persona/world/delete. Type https://trusttasks.org/spec/persona/world/delete/1.0#response.
///
/// <details><summary>JSON schema</summary>
///
/// ```json
///{
///  "title": "Response",
///  "description": "Success response to persona/world/delete. Type https://trusttasks.org/spec/persona/world/delete/1.0#response.",
///  "type": "object",
///  "required": [
///    "existed"
///  ],
...
///    },
///    "releasedFaces": {
///      "description": "How many profiles no longer belong to any world as a result. Nothing was deleted and nothing changed about them — this is the count a consumer needs to say what the screen will look like afterwards, which is the honest end of a sentence that would otherwise read only 'deleted'.",
///      "type": "integer",
///      "minimum": 0.0
///    }
///  },
...
pub struct Response {
    ...
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub ext: ::std::option::Option<Ext>,
    ///How many profiles no longer belong to any world as a result. Nothing was deleted and nothing changed about them — this is the count a consumer needs to say what the screen will look like afterwards, which is the honest end of a sentence that would otherwise read only 'deleted'.
    #[serde(
...
impl crate::Payload for Payload {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/persona/world/delete/1.0";
    const IS_PROOF_REQUIRED: bool = true;
    const IS_ISSUED_AT_REQUIRED: bool = true;
    const IS_RECIPIENT_REQUIRED: bool = true;
    const PAYLOAD_SCHEMA: Option<&'static str> = Some(
        "{\n  \"$defs\": {\n    \"ExpectedVersion\": {\n      \"description\": \"Optimistic-concurrency precondition. A positive value requires the record's current `version` to equal it exactly; zero means create-only and applies only when no live record exists at the address.\",\n      \"minimum\": 0,\n      \"title\": \"ExpectedVersion\",\n      \"type\": \"integer\"\n    },\n    \"Ext\": {\n      \"additionalProperties\": true,\n      \"description\": \"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\n      \"minProperties\": 1,\n      \"propertyNames\": {\n        \"pattern\": \"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"\n      },\n      \"title\": \"Ext\",\n      \"type\": \"object\"\n    },\n    \"Response\": {\n      \"$anchor\": \"response\",\n      \"additionalProperties\": false,\n      \"description\": \"Success response to persona/world/delete. Type https://trusttasks.org/spec/persona/world/delete/1.0#response.\",\n      \"properties\": {\n        \"existed\": {\n          \"description\": \"False when there was nothing to delete. A successful no-op rather than an error: a producer retrying after a lost response must be able to reach the state it wanted without having to tell a second delete apart from a first.\",\n          \"type\": \"boolean\"\n        },\n        \"ext\": {\n          \"$ref\": \"#/$defs/Ext\"\n        },\n        \"releasedFaces\": {\n          \"description\": \"How many profiles no longer belong to any world as a result. Nothing was deleted and nothing changed about them — this is the count a consumer needs to say what the screen will look like afterwards, which is the honest end of a sentence that would otherwise read only 'deleted'.\",\n          \"minimum\": 0,\n          \"type\": \"integer\"\n        }\n      },\n      \"required\": [\n        \"existed\"\n      ],\n      \"title\": \"Persona World Delete — response payload\",\n      \"type\": \"object\"\n    },\n    \"Ulid\": {\n      \"description\": \"A ULID in Crockford base32, uppercase. Used for `attributeId` and `profileId`. Chosen over a UUID because the leading 48 bits are a timestamp, so a key-ordered scan of the store is also creation-ordered and a `list` needs no secondary sort. Server-assigned on create; a producer MAY supply one to make a create idempotent, and a maintainer MUST reject a supplied value that already exists rather than silently overwriting.\",\n      \"pattern\": \"^[0-9A-HJKMNP-TV-Z]{26}$\",\n      \"title\": \"Ulid\",\n      \"type\": \"string\"\n    }\n  },\n  \"$id\": \"https://trusttasks.org/spec/persona/world/delete/1.0\",\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"additionalProperties\": false,\n  \"description\": \"Delete one world. The faces and attributes that belonged to it are untouched — a world is a way of arranging what the holder keeps, never a container for it.\",\n  \"properties\": {\n    \"expectedVersion\": {\n      \"$ref\": \"#/$defs/ExpectedVersion\",\n      \"description\": \"Optional precondition. Supply the version a prior read returned to refuse a delete against a world that has changed since it was looked at.\"\n    },\n    \"ext\": {\n      \"$ref\": \"#/$defs/Ext\"\n    },\n    \"worldId\": {\n      \"$ref\": \"#/$defs/Ulid\"\n    }\n  },\n  \"required\": [\n    \"worldId\"\n  ],\n  \"title\": \"Persona — World Delete — payload\",\n  \"type\": \"object\"\n}\n",
    );
}
impl crate::Payload for Response {
    const TYPE_URI: &'static str = "https://trusttasks.org/spec/persona/world/delete/1.0#response";
    const IS_PROOF_REQUIRED: bool = true;
    const IS_ISSUED_AT_REQUIRED: bool = true;
    const IS_RECIPIENT_REQUIRED: bool = true;
    const PAYLOAD_SCHEMA: Option<&'static str> = Some(
...
/// declared.
pub mod error_codes {
    /// `persona/world/delete:versionConflict`
    ///
    /// The `expectedVersion` precondition failed — the world changed after the caller read it. Details carry the maintainer's current version. Nothing is deleted.
    ///
