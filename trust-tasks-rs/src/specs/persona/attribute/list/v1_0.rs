...
impl ::std::default::Default for Payload {
    fn default() -> Self {
        Self {
            ...
            ext: Default::default(),
            include_sensitive: Default::default(),
...
/// declared.
pub mod error_codes {
    /// `persona/attribute/list:cursorInvalid`
    ///
    /// The supplied `cursor` is unrecognised, expired, or was issued against a different filter. A producer restarts the enumeration rather than attempting to repair the token.
    ///
