...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::BOUND];
...
/// declared.
pub mod error_codes {
    /// `persona/local/profile/delete:bound`
    ///
    /// A persona is still bound and unbind was not set. The details name the bound personas.
    ///
