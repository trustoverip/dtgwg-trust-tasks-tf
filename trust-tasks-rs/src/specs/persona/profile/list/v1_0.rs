...
//!
//! Spec slug: `persona/profile/list`. Version: `1.0`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/persona/profile/list/1.0",
///  "title": "Payload",
///  "description": "Enumerate the holder's profiles. Compositions only — entries are returned, values are not.",
///  "type": "object",
///  "properties": {
///    "cursor": {
...
pub struct Payload {
    ...
    #[serde(rename = "includeRetired", default)]
...
impl ::std::default::Default for Payload {
    fn default() -> Self {
        Self {
            ...
            ext: Default::default(),
            include_retired: Default::default(),
...
///{
///  "title": "Response",
///  "description": "Success response to persona/profile/list. Type https://trusttasks.org/spec/persona/profile/list/1.0#response. Profiles are returned as composed; there is no resolve option here, because resolving every profile in one call would decrypt the holder's entire pool to answer a question about names.",
///  "type": "object",
///  "required": [
///    "profiles"
///  ],
...
///    },
///    "nextCursor": {
///      "description": "Present when more remain. Its absence is the only exhaustion signal.",
///      "type": "string",
///      "maxLength": 4096
///    },
///    "profiles": {
...
pub mod builder {
    ...
    pub struct Payload {
        ...
        include_retired: ::std::result::Result<bool, ::std::string::String>,
    ...
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                ...
                include_retired: Ok(Default::default()),
    ...
    impl Payload {
        ...
        pub fn include_retired<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<bool>,
            T::Error: ::std::fmt::Display,
        {
            self.include_retired = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for include_retired: {e}"));
            self
        }
    ...
    impl ::std::convert::From<super::Payload> for Payload {
        fn from(value: super::Payload) -> Self {
            Self {
                ...
                ext: Ok(value.ext),
                include_retired: Ok(value.include_retired),
    ...
    pub struct Response {
        ...
        next_cursor: ::std::result::Result<
            ...
            ::std::string::String,
        >,
        profiles: ::std::result::Result<::std::vec::Vec<super::Profile>, ::std::string::String>,
    }
    ...
    impl Response {
        ...
        where
            T: ::std::convert::TryInto<::std::vec::Vec<super::Profile>>,
            T::Error: ::std::fmt::Display,
        {
            self.profiles = value
                .try_into()
...
/// declared.
pub mod error_codes {
    /// `persona/profile/list:cursorInvalid`
    ///
    /// The supplied cursor is unrecognised or expired. A producer restarts the enumeration rather than repairing the token.
    ///
