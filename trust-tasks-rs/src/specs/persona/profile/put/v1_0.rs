...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[
    ...
    error_codes::BOUND_OUTSIDE_REACH,
...
pub mod error_codes {
    ...
    ///
    /// The new `reach` excludes contexts the face is worn in now. The details name them. Nothing is written — narrowing where a face may go must not silently take it off where it is.
    ///
    /// Declared `retryable: false`.
    pub const BOUND_OUTSIDE_REACH: crate::DeclaredErrorCode = crate::DeclaredErrorCode {
