...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::CURSOR_INVALID];
...
/// declared.
pub mod error_codes {
    /// `persona/contact/list:cursorInvalid`
    ///
    /// The supplied cursor is unrecognised or expired. A producer restarts the enumeration.
    ///
