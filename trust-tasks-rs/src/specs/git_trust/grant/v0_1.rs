...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::ALREADY_GRANTED];
...
/// declared.
pub mod error_codes {
    /// `git-trust/grant:alreadyGranted`
    ///
    /// An active grant already exists for this subject and resource.
    ///
