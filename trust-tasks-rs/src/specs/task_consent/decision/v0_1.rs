...
pub mod builder {
    ...
    #[derive(Clone, Debug)]
    pub struct Response {
        approvals: ::std::result::Result<::std::option::Option<u64>, ::std::string::String>,
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
        needed: ::std::result::Result<
    ...
    impl Response {
        ...
        pub fn needed<T>(mut self, value: T) -> Self
        where
            ...
            T::Error: ::std::fmt::Display,
        {
            self.needed = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for needed: {e}"));
            self
        }
        pub fn payload_digest<T>(mut self, value: T) -> Self
        where
