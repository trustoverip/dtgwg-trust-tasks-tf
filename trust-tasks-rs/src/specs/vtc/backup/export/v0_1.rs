...
//!
//! Spec slug: `vtc/backup/export`. Version: `0.1`.
...
pub struct Payload {
    ...
    #[serde(rename = "includeAudit", default)]
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::PASSWORD_TOO_SHORT];
...
pub mod error_codes {
    ...
    ///
    /// The supplied password is under the 12-character minimum.
    ///
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            ...
            (
                "Password under the 12-character minimum.",
                "{\n  \"password\": \"short\"\n}",
            ),
            (
            ...
            (
                "`includeAudit` must be a boolean, not a string.",
                "{\n  \"includeAudit\": \"yes\",\n  \"password\": \"twelve-char-pw!!\"\n}",
            ),
        ];
