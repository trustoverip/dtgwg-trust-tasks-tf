...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::UNKNOWN_ROLE];
...
/// declared.
pub mod error_codes {
    /// `vtc/invitations/issue:unknownRole`
    ///
    /// The requested `role` is not one this community defines.
    ///
