...
//!
//! Spec slug: `vtc/auth/admin-session`. Version: `0.1`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/vtc/auth/admin-session/0.1",
///  "title": "Payload",
///  "type": "object",
///  "required": [
///    "accessToken"
...
///  "properties": {
///    "accessToken": {
///      "description": "A currently-valid bearer access token issued by this community.",
///      "type": "string",
///      "minLength": 1
///    },
///    "ext": {
...
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct PayloadAccessToken(::std::string::String);
impl ::std::ops::Deref for PayloadAccessToken {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<PayloadAccessToken> for ::std::string::String {
    fn from(value: PayloadAccessToken) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for PayloadAccessToken {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl ::std::convert::TryFrom<&str> for PayloadAccessToken {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for PayloadAccessToken {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for PayloadAccessToken {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
/// declared.
pub mod error_codes {
    /// `vtc/auth/admin-session:invalidToken`
    ///
    /// The access token is malformed, expired, or was not issued by this community.
    ///
