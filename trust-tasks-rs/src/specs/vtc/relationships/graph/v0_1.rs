...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::PERMISSION_DENIED];
...
/// declared.
pub mod error_codes {
    /// `vtc/relationships/graph:permissionDenied`
    ///
    /// The consumer lacks the community-admin capability.
    ///
