...
//!
//! Spec slug: `vtc/join-requests/submit-receipt`. Version: `0.1`.
...
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct PayloadStatus(::std::string::String);
impl ::std::ops::Deref for PayloadStatus {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<PayloadStatus> for ::std::string::String {
...
impl<'de> ::serde::Deserialize<'de> for PayloadStatus {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
/// declared.
pub mod error_codes {
    /// `vtc/join-requests/submit-receipt:unknownRequest`
    ///
    /// The recipient has no record of submitting a request matching this receipt.
    ///
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            (
                "`requestId` and `status` are both required.",
                "{\n  \"requestId\": \"req-1\"\n}",
            ),
            (
