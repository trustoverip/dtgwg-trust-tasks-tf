...
//!
//! Spec slug: `vtc/join-requests/approve`. Version: `0.1`.
...
/// declared.
pub mod error_codes {
    /// `vtc/join-requests/approve:permissionDenied`
    ///
    ...
    ///
    /// The request is not in the pending state, so it cannot be approved.
    ///
    /// Declared `retryable: false`.
