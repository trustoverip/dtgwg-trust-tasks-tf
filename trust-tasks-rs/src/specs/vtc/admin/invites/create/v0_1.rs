...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::TTL_TOO_LONG];
...
/// declared.
pub mod error_codes {
    /// `vtc/admin/invites/create:ttlTooLong`
    ///
    /// The requested `ttlSeconds` exceeds the 24-hour maximum.
    ///
