...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[
    ...
    error_codes::ALREADY_BOOTSTRAPPED,
];
...
/// declared.
pub mod error_codes {
    /// `vtc/admin/bootstrap:invalidToken`
    ///
    /// The setup-session token is missing, malformed, expired, or already consumed.
    ///
    ...
    ///
    /// The community already has an admin; bootstrap is single-use.
    ///
    /// Declared `retryable: false`.
