...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::NOT_MEMBER];
...
/// declared.
pub mod error_codes {
    /// `vtc/vetting/vetters/grant:notMember`
    ///
    /// `memberDid` is not an active member of this community. Only members can be vetters.
    ///
