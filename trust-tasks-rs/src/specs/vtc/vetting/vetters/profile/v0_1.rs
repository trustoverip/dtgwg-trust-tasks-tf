...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::NOT_ELIGIBLE];
...
pub mod error_codes {
    ...
    ///
    /// The sender is not an active member of this community holding a live vetter grant.
    ///
