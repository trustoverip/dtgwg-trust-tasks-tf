...
/// declared.
pub mod error_codes {
    /// `vtc/vetting/vetters/resend:notGranted`
    ///
    /// The sender holds no live vetter grant in this community: it was never granted, has expired or been revoked, or the sender is not an active member.
    ///
