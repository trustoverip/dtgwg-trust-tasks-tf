...
pub mod builder {
    ...
    #[derive(Clone, Debug)]
    pub struct Response {
        did_binding_challenge:
            ::std::result::Result<super::ResponseDidBindingChallenge, ::std::string::String>,
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
    ...
    impl ::std::default::Default for Response {
        fn default() -> Self {
            Self {
                did_binding_challenge: Err(
                    "no value supplied for did_binding_challenge".to_string()
                ),
                ext: Ok(Default::default()),
    ...
    impl Response {
        pub fn did_binding_challenge<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::ResponseDidBindingChallenge>,
            T::Error: ::std::fmt::Display,
        {
            self.did_binding_challenge = value.try_into().map_err(|e| {
                format!("error converting supplied value for did_binding_challenge: {e}")
            });
            self
        }
        pub fn ext<T>(mut self, value: T) -> Self
    ...
    impl ::std::convert::TryFrom<Response> for super::Response {
        ...
        fn try_from(value: Response) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                did_binding_challenge: value.did_binding_challenge?,
                ext: value.ext?,
    ...
    impl ::std::convert::From<super::Response> for Response {
        fn from(value: super::Response) -> Self {
            Self {
                did_binding_challenge: Ok(value.did_binding_challenge),
                ext: Ok(value.ext),
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::INVALID_TOKEN];
...
/// declared.
pub mod error_codes {
    /// `vtc/install/claim/start:invalidToken`
    ///
