...
pub mod builder {
    ...
    pub struct Payload {
        ...
        include_revoked: ::std::result::Result<::std::option::Option<bool>, ::std::string::String>,
        limit: ::std::result::Result<
            ::std::option::Option<::std::num::NonZeroU64>,
            ::std::string::String,
        >,
        subject_did: ::std::result::Result<
            ::std::option::Option<super::PayloadSubjectDid>,
            ::std::string::String,
        >,
        type_uri: ::std::result::Result<
            ::std::option::Option<super::PayloadTypeUri>,
            ::std::string::String,
        >,
    }
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                ...
                include_revoked: Ok(Default::default()),
                limit: Ok(Default::default()),
                subject_did: Ok(Default::default()),
    ...
    impl Payload {
        ...
        pub fn include_revoked<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<bool>>,
            T::Error: ::std::fmt::Display,
        {
            self.include_revoked = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for include_revoked: {e}"));
            self
        }
        ...
        pub fn subject_did<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::PayloadSubjectDid>>,
            T::Error: ::std::fmt::Display,
        {
            self.subject_did = value
                .try_into()
        ...
        pub fn type_uri<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::PayloadTypeUri>>,
            T::Error: ::std::fmt::Display,
        {
            self.type_uri = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<Payload> for super::Payload {
        ...
        fn try_from(value: Payload) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                cursor: value.cursor?,
                ext: value.ext?,
                include_revoked: value.include_revoked?,
                limit: value.limit?,
                subject_did: value.subject_did?,
                type_uri: value.type_uri?,
            })
    ...
    impl ::std::convert::From<super::Payload> for Payload {
        fn from(value: super::Payload) -> Self {
            Self {
                ...
                ext: Ok(value.ext),
                include_revoked: Ok(value.include_revoked),
    ...
    pub struct Response {
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
        items: ::std::result::Result<::std::vec::Vec<super::Endorsement>, ::std::string::String>,
    ...
    impl Response {
        ...
        where
            T: ::std::convert::TryInto<::std::vec::Vec<super::Endorsement>>,
            T::Error: ::std::fmt::Display,
        {
            self.items = value
                .try_into()
...
pub mod error_codes {
    ...
    ///
    /// The supplied `cursor` is malformed or has expired.
    ///
