...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[error_codes::NOT_MANAGED];
...
/// declared.
pub mod error_codes {
    /// `vtc/website/generations/list:notManaged`
    ///
    /// The website is in live mode, which has no generations. Managed mode only.
    ///
