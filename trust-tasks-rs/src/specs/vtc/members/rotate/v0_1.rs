...
/// declared.
pub mod error_codes {
    /// `vtc/members/rotate:rotationExpired`
    ///
    /// The rotationId is unknown or its challenge has expired. Start a new rotate-challenge.
    ///
    ...
    ///
    /// The old or new signature did not verify over the challenge, so control of both keys was not proven.
    ///
    /// Declared `retryable: false`.
