...
pub mod builder {
    ...
    #[derive(Clone, Debug)]
    pub struct Response {
        challenge_id: ::std::result::Result<super::ResponseChallengeId, ::std::string::String>,
        expires_at:
    ...
    impl Response {
        ...
        where
            T: ::std::convert::TryInto<super::ResponseChallengeId>,
            T::Error: ::std::fmt::Display,
        {
...
/// declared.
pub mod error_codes {
    /// `vtc/members/personhood/challenge:notFound`
    ///
