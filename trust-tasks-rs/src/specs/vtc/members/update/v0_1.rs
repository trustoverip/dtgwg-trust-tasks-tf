...
//!
//! Spec slug: `vtc/members/update`. Version: `0.1`.
...
pub struct Payload {
    #[serde(
        rename = "departurePreference",
        default,
        skip_serializing_if = "::std::option::Option::is_none"
    )]
    pub departure_preference: ::std::option::Option<PayloadDeparturePreference>,
    ...
    pub publish_consent: ::std::option::Option<bool>,
...
#[non_exhaustive]
pub enum PayloadDeparturePreference {
    #[serde(rename = "purge")]
    Purge,
    #[serde(rename = "tombstone")]
    Tombstone,
...
impl ::std::fmt::Display for PayloadDeparturePreference {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match *self {
            Self::Purge => f.write_str("purge"),
            Self::Tombstone => f.write_str("tombstone"),
...
impl ::std::str::FromStr for PayloadDeparturePreference {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        match value {
            "purge" => Ok(Self::Purge),
...
impl ::std::convert::TryFrom<&str> for PayloadDeparturePreference {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for PayloadDeparturePreference {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
pub mod builder {
    ...
    #[derive(Clone, Debug)]
    pub struct Payload {
        departure_preference: ::std::result::Result<
            ::std::option::Option<super::PayloadDeparturePreference>,
            ::std::string::String,
        >,
    ...
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                departure_preference: Ok(Default::default()),
                did: Err("no value supplied for did".to_string()),
                ext: Ok(Default::default()),
                extensions: Ok(Default::default()),
                label: Ok(Default::default()),
                publish_consent: Ok(Default::default()),
    ...
    impl Payload {
        pub fn departure_preference<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::PayloadDeparturePreference>>,
            T::Error: ::std::fmt::Display,
        {
            self.departure_preference = value.try_into().map_err(|e| {
                format!("error converting supplied value for departure_preference: {e}")
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            ...
            ("`did` is required.", "{\n  \"role\": \"moderator\"\n}"),
            (
                "`departurePreference` must be one of the enum values.",
                "{\n  \"departurePreference\": \"delete\",\n  \"did\": \"did:key:z6Mk\"\n}",
            ),
        ];
