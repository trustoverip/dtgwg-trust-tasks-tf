...
//!
//! Spec slug: `webvh/witness/publish`. Version: `0.1`.
...
/// ```json
///{
///  "$id": "https://trusttasks.org/spec/webvh/witness/publish/0.1",
///  "title": "Payload",
///  "type": "object",
///  "required": [
///    "mnemonic",
...
///    },
///    "witness": {
///      "description": "Witness proof object per the did:webvh specification. Shape is method-defined; consumers validate the signature against the configured witness DID(s).",
///      "type": "object"
///    }
///  },
...
pub mod builder {
    ...
    pub struct Response {
        ...
        witness_url: ::std::result::Result<::std::string::String, ::std::string::String>,
    }
    impl ::std::default::Default for Response {
        fn default() -> Self {
            Self {
                ext: Ok(Default::default()),
                mnemonic: Err("no value supplied for mnemonic".to_string()),
                witness_url: Err("no value supplied for witness_url".to_string()),
            }
        }
    }
    impl Response {
        ...
        pub fn witness_url<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::string::String>,
            T::Error: ::std::fmt::Display,
        {
            self.witness_url = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for witness_url: {e}"));
            self
        }
    }
    ...
    impl ::std::convert::From<super::Response> for Response {
        fn from(value: super::Response) -> Self {
            Self {
                ext: Ok(value.ext),
                mnemonic: Ok(value.mnemonic),
                witness_url: Ok(value.witness_url),
            }
        }
    }
}
impl crate::Payload for Payload {
    ...
    const PAYLOAD_SCHEMA: Option<&'static str> = Some(
        "{\n  \"$defs\": {\n    \"Ext\": {\n      \"additionalProperties\": true,\n      \"description\": \"Vendor-namespaced extension object per SPEC.md §4.5.1. Each immediate key MUST be a reverse-DNS namespace; structure under each namespace is opaque to the framework.\",\n      \"minProperties\": 1,\n      \"propertyNames\": {\n        \"pattern\": \"^[a-z][a-z0-9-]*(\\\\.[a-z0-9-]+)+$\"\n      },\n      \"title\": \"Ext\",\n      \"type\": \"object\"\n    },\n    \"Response\": {\n      \"$anchor\": \"response\",\n      \"additionalProperties\": false,\n      \"properties\": {\n        \"ext\": {\n          \"$ref\": \"#/$defs/Ext\"\n        },\n        \"mnemonic\": {\n          \"type\": \"string\"\n        },\n        \"witnessUrl\": {\n          \"format\": \"uri\",\n          \"type\": \"string\"\n        }\n      },\n      \"required\": [\n        \"mnemonic\",\n        \"witnessUrl\"\n      ],\n      \"title\": \"WebVH Witness Publish — response payload\",\n      \"type\": \"object\"\n    }\n  },\n  \"$id\": \"https://trusttasks.org/spec/webvh/witness/publish/0.1\",\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"additionalProperties\": false,\n  \"properties\": {\n    \"ext\": {\n      \"$ref\": \"#/$defs/Ext\"\n    },\n    \"mnemonic\": {\n      \"minLength\": 1,\n      \"type\": \"string\"\n    },\n    \"witness\": {\n      \"description\": \"Witness proof object per the did:webvh specification. Shape is method-defined; consumers validate the signature against the configured witness DID(s).\",\n      \"type\": \"object\"\n    }\n  },\n  \"required\": [\n    \"mnemonic\",\n    \"witness\"\n  ],\n  \"title\": \"WebVH Witness Publish — payload\",\n  \"type\": \"object\"\n}\n",
    );
}
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            (
                "Empty payload omits required member(s): mnemonic, witness.",
                "{}",
            ),
            (
