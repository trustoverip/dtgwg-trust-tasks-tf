...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[
    error_codes::UNKNOWN_CONVERSATION,
    error_codes::BROKEN_CHAIN,
...
/// declared.
pub mod error_codes {
    /// `chat/message:unknownConversation`
    ///
    /// No conversation matches `conversationId` at this consumer.
    ///
    /// Declared `retryable: false`.
    pub const UNKNOWN_CONVERSATION: crate::DeclaredErrorCode = crate::DeclaredErrorCode {
        code: "chat/message:unknownConversation",
        retryable: false,
    };
    /// `chat/message:brokenChain`
    ///
    /// `prev` does not reference the consumer's last-seen message for this conversation — a gap, reorder, or fork.
    ///
    /// Declared `retryable: false`.
    pub const BROKEN_CHAIN: crate::DeclaredErrorCode = crate::DeclaredErrorCode {
        code: "chat/message:brokenChain",
        retryable: false,
    };
    /// `chat/message:unsupportedContent`
    ///
    /// The message carries content (e.g. an attachment kind) the consumer or its platform cannot represent.
    ///
    /// Declared `retryable: false`.
    pub const UNSUPPORTED_CONTENT: crate::DeclaredErrorCode = crate::DeclaredErrorCode {
