...
pub mod builder {
    ...
    pub struct Payload {
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
        from_role: ::std::result::Result<super::PayloadFromRole, ::std::string::String>,
        reason: ::std::result::Result<
            ::std::option::Option<::std::string::String>,
            ::std::string::String,
        >,
        subject: ::std::result::Result<::std::string::String, ::std::string::String>,
        to_role: ::std::result::Result<super::PayloadToRole, ::std::string::String>,
    }
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                ext: Ok(Default::default()),
                from_role: Err("no value supplied for from_role".to_string()),
                reason: Ok(Default::default()),
                subject: Err("no value supplied for subject".to_string()),
                to_role: Err("no value supplied for to_role".to_string()),
            }
        }
    }
    impl Payload {
        ...
        pub fn from_role<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::PayloadFromRole>,
            T::Error: ::std::fmt::Display,
        {
            self.from_role = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for from_role: {e}"));
            self
        }
        ...
        pub fn to_role<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::PayloadToRole>,
            T::Error: ::std::fmt::Display,
        {
            self.to_role = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for to_role: {e}"));
            self
        }
    }
    ...
    impl ::std::convert::From<super::Payload> for Payload {
        fn from(value: super::Payload) -> Self {
            Self {
                ext: Ok(value.ext),
                from_role: Ok(value.from_role),
                reason: Ok(value.reason),
                subject: Ok(value.subject),
                to_role: Ok(value.to_role),
            }
        }
    }
    #[derive(Clone, Debug)]
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            ...
            (
                "Missing required `toRole`.",
                "{\n  \"fromRole\": \"member\",\n  \"subject\": \"did:web:alice.example\"\n}",
            ),
            (
                "Empty `toRole` violates minLength: 1.",
                "{\n  \"fromRole\": \"member\",\n  \"subject\": \"did:web:alice.example\",\n  \"toRole\": \"\"\n}",
            ),
        ];
