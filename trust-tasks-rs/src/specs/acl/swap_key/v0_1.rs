...
pub mod builder {
    ...
    #[derive(Clone, Debug)]
    pub struct Payload {
        current_subject: ::std::result::Result<super::PayloadCurrentSubject, ::std::string::String>,
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
        link_proof: ::std::result::Result<
            ::std::option::Option<super::PayloadLinkProof>,
            ::std::string::String,
        >,
        new_subject: ::std::result::Result<super::PayloadNewSubject, ::std::string::String>,
    ...
    impl ::std::default::Default for Payload {
        fn default() -> Self {
            Self {
                current_subject: Err("no value supplied for current_subject".to_string()),
                ext: Ok(Default::default()),
                link_proof: Ok(Default::default()),
                new_subject: Err("no value supplied for new_subject".to_string()),
                reason: Ok(Default::default()),
            }
        }
    }
    impl Payload {
        pub fn current_subject<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::PayloadCurrentSubject>,
            T::Error: ::std::fmt::Display,
        {
            self.current_subject = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for current_subject: {e}"));
            self
        }
        pub fn ext<T>(mut self, value: T) -> Self
        where
        ...
        pub fn link_proof<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::PayloadLinkProof>>,
            T::Error: ::std::fmt::Display,
        {
            self.link_proof = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for link_proof: {e}"));
            self
        }
        pub fn new_subject<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::PayloadNewSubject>,
            T::Error: ::std::fmt::Display,
        {
            self.new_subject = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for new_subject: {e}"));
            self
        }
    ...
    impl ::std::convert::TryFrom<Payload> for super::Payload {
        ...
        fn try_from(value: Payload) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                current_subject: value.current_subject?,
                ext: value.ext?,
                link_proof: value.link_proof?,
                new_subject: value.new_subject?,
                reason: value.reason?,
            })
        }
    }
    impl ::std::convert::From<super::Payload> for Payload {
        fn from(value: super::Payload) -> Self {
            Self {
                current_subject: Ok(value.current_subject),
                ext: Ok(value.ext),
                link_proof: Ok(value.link_proof),
                new_subject: Ok(value.new_subject),
    ...
    #[derive(Clone, Debug)]
    pub struct Response {
        entry: ::std::result::Result<super::AclEntry, ::std::string::String>,
        ext: ::std::result::Result<::std::option::Option<super::Ext>, ::std::string::String>,
        previous_subject:
            ::std::result::Result<super::ResponsePreviousSubject, ::std::string::String>,
    }
    impl ::std::default::Default for Response {
        fn default() -> Self {
            Self {
                ...
                ext: Ok(Default::default()),
                previous_subject: Err("no value supplied for previous_subject".to_string()),
            }
        }
    }
    impl Response {
        ...
        where
            T: ::std::convert::TryInto<super::AclEntry>,
            T::Error: ::std::fmt::Display,
        {
            self.entry = value
                .try_into()
        ...
        pub fn previous_subject<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::ResponsePreviousSubject>,
            T::Error: ::std::fmt::Display,
        {
            self.previous_subject = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for previous_subject: {e}"));
            self
        }
    }
    impl ::std::convert::TryFrom<Response> for super::Response {
        ...
        fn try_from(value: Response) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                entry: value.entry?,
                ext: value.ext?,
                previous_subject: value.previous_subject?,
            })
        }
    }
    impl ::std::convert::From<super::Response> for Response {
        fn from(value: super::Response) -> Self {
            Self {
                ...
                ext: Ok(value.ext),
                previous_subject: Ok(value.previous_subject),
            }
        }
    }
}
