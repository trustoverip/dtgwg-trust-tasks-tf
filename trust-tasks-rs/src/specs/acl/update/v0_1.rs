...
impl PayloadApprove {
    pub fn builder() -> builder::PayloadApprove {
        Default::default()
    }
}
///Replacement human-readable label. Explicit `null` clears it. Omitted leaves it unchanged.
...
impl PayloadStepUp {
    pub fn builder() -> builder::PayloadStepUp {
        Default::default()
    }
}
///Minimum step-up mode. `null` clears the per-entry override.
...
pub mod builder {
    ...
    pub struct Payload {
        ...
        >,
        approve: ::std::result::Result<
            ::std::option::Option<super::PayloadApprove>,
            ::std::string::String,
        >,
        expires_at: ::std::result::Result<
            ::std::option::Option<::chrono::DateTime<::chrono::offset::Utc>>,
        ...
        scopes:
            ::std::result::Result<::std::vec::Vec<::std::string::String>, ::std::string::String>,
        step_up: ::std::result::Result<
            ::std::option::Option<super::PayloadStepUp>,
            ::std::string::String,
        >,
    ...
    impl Payload {
        ...
        pub fn approve<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::PayloadApprove>>,
            T::Error: ::std::fmt::Display,
        {
            self.approve = value
                .try_into()
        ...
        pub fn step_up<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::PayloadStepUp>>,
            T::Error: ::std::fmt::Display,
        {
            self.step_up = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<PayloadApprove> for super::PayloadApprove {
        type Error = super::error::ConversionError;
        fn try_from(
            value: PayloadApprove,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                all: value.all?,
                scopes: value.scopes?,
    ...
    impl ::std::convert::From<super::PayloadApprove> for PayloadApprove {
        fn from(value: super::PayloadApprove) -> Self {
            Self {
                all: Ok(value.all),
                scopes: Ok(value.scopes),
            }
    ...
    pub struct PayloadStepUp {
        ...
        >,
        require: ::std::result::Result<
            ::std::option::Option<super::PayloadStepUpRequire>,
            ::std::string::String,
        >,
    }
    impl ::std::default::Default for PayloadStepUp {
    ...
    impl PayloadStepUp {
        ...
        pub fn require<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::PayloadStepUpRequire>>,
            T::Error: ::std::fmt::Display,
        {
            self.require = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<PayloadStepUp> for super::PayloadStepUp {
        type Error = super::error::ConversionError;
        fn try_from(
            value: PayloadStepUp,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
    ...
    impl ::std::convert::From<super::PayloadStepUp> for PayloadStepUp {
        fn from(value: super::PayloadStepUp) -> Self {
            Self {
                approver: Ok(value.approver),
                require: Ok(value.require),
            }
...
pub const ERROR_CODES: &[crate::DeclaredErrorCode] = &[
    ...
    error_codes::ROLE_CHANGE_NOT_PERMITTED,
    error_codes::NARROWING_NOT_PERMITTED,
];
...
pub mod error_codes {
    /// `acl/update:notFound`
    ///
    /// No entry exists for `subject`. This task amends; use acl/grant to create.
    ///
    ...
    ///
    /// The payload attempted a role change. Use acl/change-role, which requires the current role.
    ///
    /// Declared `retryable: false`.
    ...
    ///
    /// The replacement scopes remove authority the entry currently holds. Use acl/revoke.
    ///
    /// Declared `retryable: false`.
...
mod conformance {
    ...
    fn rejects_invalid_examples() {
        ...
        let fixtures: &[(&str, &str)] = &[
            ...
            (
                "`allowedKeys` must be an array of strings (or explicit null to clear) — a bare string is neither.",
                "{\n  \"allowedKeys\": \"key-1\",\n  \"subject\": \"did:web:alice.example\"\n}",
            ),
            (
                "`allowedKeys` items must be strings.",
                "{\n  \"allowedKeys\": [\n    1\n  ],\n  \"subject\": \"did:web:alice.example\"\n}",
            ),
            (
