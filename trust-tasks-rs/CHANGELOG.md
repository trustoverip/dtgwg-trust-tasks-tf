...
## [0.23.0](https://github.com/trustoverip/dtgwg-trust-tasks-tf/compare/trust-tasks-rs-v0.22.7...trust-tasks-rs-v0.23.0) — 2026-09-26


### Added

- **git-ns**: Separation of duties for elevated rights, with an audited break-glass ([#641](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/641))
...
- **git-ns**: Drift/resolve 0.3 binds an adoption to the member it names ([#640](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/640))
...
- **git-ns**: Re-project roles on demand, and the bridge reports its role map ([#639](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/639))
...
- **vta/webvh/dids/keys**: Named key roles and per-role rotation for a VTA's DIDs ([#638](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/638))
...
- **git-ns/account/unlink**: A member unlinks their own forge account ([#636](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/636))
...
- **git-ns**: Bridge/job 0.4 and namespace/reseat 0.3, a namespace admin gets no forge role ([#635](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/635))
...
- **didcomm**: A consumer may require a proof over DIDComm ([#642](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/642))
...
- **device**: Register the keyExport capability ([#643](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/643))
...
## [0.22.7](https://github.com/trustoverip/dtgwg-trust-tasks-tf/compare/trust-tasks-rs-v0.22.6...trust-tasks-rs-v0.22.7) — 2026-09-24


### Added

- **backup**: A node-neutral backup and restore family ([#633](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/633))
...
- **auth/step-up**: A step-up bound to one operation needs no session ([#631](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/631))
...
## [0.22.6](https://github.com/trustoverip/dtgwg-trust-tasks-tf/compare/trust-tasks-rs-v0.22.5...trust-tasks-rs-v0.22.6) — 2026-09-24


### Added

- **git-ns**: Hold every DID to the W3C DID Core syntax ([#629](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/629))
...
## [0.22.5](https://github.com/trustoverip/dtgwg-trust-tasks-tf/compare/trust-tasks-rs-v0.22.4...trust-tasks-rs-v0.22.5) — 2026-09-24


### Added

- **git-ns/bridge/event**: Detach on transfer and name reuse, confine events to their namespace ([#627](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/627))
...
## [0.22.4](https://github.com/trustoverip/dtgwg-trust-tasks-tf/compare/trust-tasks-rs-v0.22.3...trust-tasks-rs-v0.22.4) — 2026-09-24


### Added

- **git-ns**: Drift resolution, namespace reseat, linked accounts in view ([#625](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/625))
...
## [0.22.3](https://github.com/trustoverip/dtgwg-trust-tasks-tf/compare/trust-tasks-rs-v0.22.2...trust-tasks-rs-v0.22.3) — 2026-09-23


### Added

- **git-ns**: Add the git namespaces specification family ([#621](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/621))
...
## [0.22.2](https://github.com/trustoverip/dtgwg-trust-tasks-tf/compare/trust-tasks-rs-v0.22.1...trust-tasks-rs-v0.22.2) — 2026-09-23


### Added

- **vtc/vetting/vetters/event-mode**: The exception to the constant drip ([#620](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/620))
...
- **vetting/attestation**: The four tasks hidden-vetter admission needs ([#618](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/618))
...
- **vtc/vetting/vetters/show**: A by-DID vetter status lookup ([#603](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/603))
...
- **specs**: Add the ExtCritical framework def, and open vetting requirements to ext ([#600](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/600))
...
- **specs**: Sign examples with eddsa-jcs-2022 ([#599](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/599))
...
- **persona**: Derived provenance, and endorsements as inventory ([#582](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/582))
...
- **spec**: Vtc/invitations/deliver/0.1 — get an invitation to the DID it admits ([#581](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/581))
...
## [0.21.14](https://github.com/trustoverip/dtgwg-trust-tasks-tf/compare/trust-tasks-rs-v0.21.13...trust-tasks-rs-v0.21.14) — 2026-09-22


### Added

- **persona**: Where a face may be worn, where it is, and what it has done ([#577](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/577))
...
- **persona**: Compose a face where it is asked for, and promote a local value ([#569](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/569))

* feat(persona): compose a face where it is asked for, and promote a local value

  persona/profile/compose/1.0 — a holder composes a face for one context
  at the moment the context asks for one, from values typed there and
  attributes already held, and may wear it in the same act. Local by
  default: a typed value stays in the face and enters no pool unless the
  claim says `share: pool`, in which case the maintainer references a pool
  attribute holding exactly that value, creating one only when none
  exists. Where the face lives follows from its claims — every claim local
  makes a context-local face, anything pooled makes a pool face — so there
  is no scope parameter a producer could set wrongly.

  persona/attribute/promote/1.0 — the deliberate widening: named entries
  of a context-local face become pool attributes, and the face moves above
  contexts with its id, order, slots and bindings unchanged. One-way,
  because the pool attribute may by then be presented elsewhere; the step
  order is specified so a failure part-way leaves the local face worn and
  a retry completes it.

  Both holder-authorized and unscoped. Design: VTI
...
- **vtc**: A community can ask an applicant to tell it about themselves ([#543](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/543))
...
- **vtc/join-requests/supplement**: Let a deferred applicant answer, instead of starting over ([#526](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/526))

Keyring finding KR-03, the half not closed by `join-requests/withdraw/0.1`
  ([#518](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/518)). A community that cannot decide a request on what it was given defers it
...
## [0.21.5](https://github.com/trustoverip/dtgwg-trust-tasks-tf/compare/trust-tasks-rs-v0.21.4...trust-tasks-rs-v0.21.5) — 2026-09-20


### Added

- **vtc/join-requests**: Withdraw/0.1 — an applicant closes their own request ([#518](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/518))
...
## [0.21.4](https://github.com/trustoverip/dtgwg-trust-tasks-tf/compare/trust-tasks-rs-v0.21.3...trust-tasks-rs-v0.21.4) — 2026-09-19
...
## [0.20.7](https://github.com/trustoverip/dtgwg-trust-tasks-tf/compare/trust-tasks-rs-v0.20.6...trust-tasks-rs-v0.20.7) — 2026-09-15


### Added

- **keys**: ML-DSA key types and signature algorithms ([#463](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/463))
...
- **vta/webvh/dids/realign-keys**: A DID's key records follow the methods it publishes ([#456](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/456))
...
- **keys**: Release one key's private half, by name ([#446](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/446))
...
- **process-attestation**: Add a provenance category, tighten the digest floor, drop the duplicated byteLength ([#437](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/437))

Three review findings from #430 that were left open at merge, resolved
  together because two of them touch the same schema.

  Category. process-attestation and trust-ceremony-receipt both shipped as
  category "framework", which the meta-schema documents as
  "framework-defined meta-tasks (trust-task-error, trust-task-discovery,
  etc.)". Neither is one: framework otherwise holds only reserved
  trust-task-* slugs. Neither is reputation either, which scores a party
  rather than an artifact's history. Adds "provenance" - evidence of how
  an artifact or a flow came to be - and points both specs at it, so
  framework again holds only what its own gloss describes. Per CLAUDE.md
  this is the two-file lockstep change: the enum in spec.meta.schema.json
  and the TT_CATEGORIES entry in website/assets/data.js, which is source
  and is not regenerated by the build.

  Digest floor. The pattern admitted 16 base64url characters, about 96
  bits, below every algorithm in the enum - sha-256 is 43 characters and
  sha-512 is 86. A truncated or algorithm-mismatched digest therefore
  reached a Verifier as a well-formed artifact identifier. The floor is
  now 43. Every digest in the examples and fixtures is already 43, so
  nothing in the registry moves.

  Duplicated byteLength. disclosed.document.byteLength restated
  artifact.byteLength with nothing requiring the two to agree - the exact
  trap the spec calls out a few paragraphs earlier when it declines to
  make the determination a disclosure category. Removed, rather than
  legislated against, so the disagreement is unrepresentable: document now
  carries only what artifact does not. The worked example and the
  disclosure prose are updated to match.

  Breaking. Removing the member drops a field from the generated Disclosed
  type in both libraries, and the digest floor rejects documents that
  previously validated. In place in 0.1 per SPEC 5.2 - both specs are
  draft, so schema and prose may change without notice.



## [0.19.4](https://github.com/trustoverip/dtgwg-trust-tasks-tf/compare/trust-tasks-rs-v0.19.3...trust-tasks-rs-v0.19.4) — 2026-09-10


### Added

- **process-attestation**: Add Process Attestation Trust Task 0.1 ([#430](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/430))

* feat(process-attestation): add Process Attestation Trust Task 0.1

- **rooms/epoch/commits**: A host relays commits, so a renewal is not O(n) deliveries ([#432](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/432))
...
- **rooms/epoch/prune**: A room decides to stop being able to read its own past ([#431](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/431))
...
- **rooms/owner/anchor**: A room writes its own state where a host cannot ([#429](https://github.com/trustoverip/dtgwg-trust-tasks-tf/pull/429))
