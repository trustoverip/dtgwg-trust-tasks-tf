...
/**
 * Request payload for vta/services/enable. Adds a transport to the agent's DID document and republishes the signed log. Enabling a transport already enabled is a conflict, not a no-op — use `update` to change its settings.
 */
export interface VTAServicesEnablePayload {
  service: ServiceKind;
  /**
...
/**
 * Success response to vta/services/enable. Type https://trusttasks.org/spec/vta/services/enable/1.0#response.
 */
export interface VTAServicesEnableResponsePayload {
...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/vta/services/enable/1.0" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = VTAServicesEnablePayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/vta/services/enable/1.0#response" as const;

/** Stable alias for this specification's success-response payload shape. */
export type Response = VTAServicesEnableResponsePayload;
