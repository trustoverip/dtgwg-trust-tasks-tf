 ...
 */
export interface VTAWebVHDIDsKeysMigratePayload {
  /**
   ...
   * @minItems 1
   */
  attestationKeyTypes: [KeyType, ...KeyType[]];
  /**
   * Algorithm of the new operational key. Absent means `ed25519`.
   */
  operationalKeyType?: KeyType;
  /**
 ...
 */
export interface VTAWebVHDIDsKeysMigrateResponsePayload {
  did: string;
...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/vta/webvh/dids/keys/migrate/1.0" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = VTAWebVHDIDsKeysMigratePayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/vta/webvh/dids/keys/migrate/1.0#response" as const;

/** Stable alias for this specification's success-response payload shape. */
export type Response = VTAWebVHDIDsKeysMigrateResponsePayload;
