...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/vta/did-templates/create/3.0" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = VTADIDTemplateCreatePayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/vta/did-templates/create/3.0#response" as const;
