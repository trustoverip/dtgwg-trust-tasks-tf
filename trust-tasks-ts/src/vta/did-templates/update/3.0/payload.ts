...
import type { Builtin_VtaV0_1 as Builtin, Context_VtaV0_1 as Context, DidTemplate_VtaV0_2 as DidTemplate, DidTemplateRecord_VtaV0_2 as DidTemplateRecord, Ext, Global_VtaV0_1 as Global, Scope_VtaV0_1 as Scope } from "../../../../_shared/components.js";
...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/vta/did-templates/update/3.0" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = VTADIDTemplateUpdatePayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/vta/did-templates/update/3.0#response" as const;
...
export const PAYLOAD_SCHEMA = {
  ...
  "$id": "https://trusttasks.org/spec/vta/did-templates/update/3.0",
