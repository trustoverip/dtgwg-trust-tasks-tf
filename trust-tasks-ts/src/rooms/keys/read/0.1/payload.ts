...
import type { DataCommitment, DigestMultibase, Ext, HeadVersion, ReadVerification, RecordCount } from "../../../../_shared/components.js";
 ...
 */
export interface RoomsKeysReadPayload {
  /**
 ...
 */
export interface RoomsKeysReadResponsePayload {
  roomId: string;
  key: string;
  /**
...
export type { DataCommitment, DigestMultibase, Ext, HeadVersion, ReadVerification, RecordCount };

/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/rooms/keys/read/0.1" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = RoomsKeysReadPayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/rooms/keys/read/0.1#response" as const;

/** Stable alias for this specification's success-response payload shape. */
export type Response = RoomsKeysReadResponsePayload;
