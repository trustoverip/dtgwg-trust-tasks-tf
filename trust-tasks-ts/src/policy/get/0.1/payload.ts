...
export interface PolicyGetPayload {
  /**
...
export interface PolicyGetResponsePayload {
  policy: PolicyModule;
  ext?: Ext;
}
...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/policy/get/0.1" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = PolicyGetPayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/policy/get/0.1#response" as const;

/** Stable alias for this specification's success-response payload shape. */
export type Response = PolicyGetResponsePayload;
...
export const PAYLOAD_SCHEMA = {
  ...
  "$id": "https://trusttasks.org/spec/policy/get/0.1",
  "title": "Policy Get — payload",
  "type": "object",
  ...
  "properties": {
    "id": {
      "type": "string",
      "minLength": 1,
      "description": "The id of the policy module to fetch."
    },
    "ext": {
      "$ref": "#/$defs/Ext"
    }
  ...
  "$defs": {
    "Response": {
      "$anchor": "response",
      "title": "Policy Get — response payload",
      "type": "object",
      "additionalProperties": false,
      "required": [
        "policy"
