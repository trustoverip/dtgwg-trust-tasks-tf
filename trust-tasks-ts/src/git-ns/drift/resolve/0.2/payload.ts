...
import type { Did_GitNsV0_3 as Did, DriftItem, DriftType, Ext, ForgeAccount, ForgeHost, ForgeId, RepoResource, Resource, Right, RightRecord_GitNsV0_3 as RightRecord, Sync } from "../../../../_shared/components.js";
...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/git-ns/drift/resolve/0.2" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = GitNamespacesResolveDriftPayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/git-ns/drift/resolve/0.2#response" as const;
...
export const PAYLOAD_SCHEMA = {
  ...
  "$id": "https://trusttasks.org/spec/git-ns/drift/resolve/0.2",
