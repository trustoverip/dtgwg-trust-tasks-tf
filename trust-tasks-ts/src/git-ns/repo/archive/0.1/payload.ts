...
/**
 * An owner archives a repository. The forge makes it read-only, and every `git.commit.sign` right recorded on it is revoked and withdrawn from the Trust Registry.
 */
export interface GitNamespacesArchiveRepositoryPayload {
  /**
 ...
 */
export interface GitNamespacesArchiveRepositoryResponsePayload {
  /**
   * The repository, now `archived`.
   */
  repo: RepoSummary;
  /**
   * How many `git.commit.sign` records were revoked. 0 when the repository was already archived.
   */
  rightsRevoked: number;
  ext?: Ext;
}
...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/git-ns/repo/archive/0.1" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = GitNamespacesArchiveRepositoryPayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/git-ns/repo/archive/0.1#response" as const;

/** Stable alias for this specification's success-response payload shape. */
export type Response = GitNamespacesArchiveRepositoryResponsePayload;
...
export const PAYLOAD_SCHEMA = {
  ...
  "$id": "https://trusttasks.org/spec/git-ns/repo/archive/0.1",
  "title": "Git Namespaces — Archive Repository — payload",
  "description": "An owner archives a repository. The forge makes it read-only, and every `git.commit.sign` right recorded on it is revoked and withdrawn from the Trust Registry.",
  "type": "object",
  ...
  "properties": {
    "resource": {
      ...
      "description": "The repository to archive."
    },
    "ext": {
      "$ref": "#/$defs/Ext"
    }
  ...
  "$defs": {
    "Response": {
      "$anchor": "response",
      "title": "Git Namespaces — Archive Repository — response payload",
      "description": "The archived repository.",
      "type": "object",
      "additionalProperties": false,
      "required": [
        "repo",
      ...
      "properties": {
        "repo": {
          ...
          "description": "The repository, now `archived`."
        },
        "rightsRevoked": {
          "type": "integer",
          "minimum": 0,
          "description": "How many `git.commit.sign` records were revoked. 0 when the repository was already archived."
        },
        "ext": {
          "$ref": "#/$defs/Ext"
        }
