...
import type { Bootstrap, Did_GitNsV0_3 as Did, DriftItem, Ext, ForgeAccount, ForgeHost, ForgeId, NamespaceId, RepoResource, RepoSummary_GitNsV0_3 as RepoSummary, RepoVisibility, Segment, Sync } from "../../../../_shared/components.js";
...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/git-ns/repo/create/0.3" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = GitNamespacesCreateRepositoryPayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/git-ns/repo/create/0.3#response" as const;
