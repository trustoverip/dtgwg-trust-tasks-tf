...
import type { Did_GitNsV0_3 as Did, Ext, Resource, Right, RightRecord_GitNsV0_3 as RightRecord } from "../../../../_shared/components.js";
...
export type { Did, Ext, Resource, Right, RightRecord };

/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/git-ns/right/revoke/0.2" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = GitNamespacesRevokeRightPayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/git-ns/right/revoke/0.2#response" as const;
