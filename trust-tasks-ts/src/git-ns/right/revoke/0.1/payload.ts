...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/git-ns/right/revoke/0.1" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = GitNamespacesRevokeRightPayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/git-ns/right/revoke/0.1#response" as const;
