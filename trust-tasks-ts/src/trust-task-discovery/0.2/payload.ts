...
/**
 * List of bare Type URIs the responding party supports. Carried in a Trust Task document whose type is https://trusttasks.org/spec/trust-task-discovery/0.2#response.
 */
...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/trust-task-discovery/0.2" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = TrustTaskDiscoveryPayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/trust-task-discovery/0.2#response" as const;
...
export const PAYLOAD_SCHEMA = {
  ...
  "$id": "https://trusttasks.org/spec/trust-task-discovery/0.2",
  ...
  "$defs": {
    "Response": {
      ...
      "description": "List of bare Type URIs the responding party supports. Carried in a Trust Task document whose type is https://trusttasks.org/spec/trust-task-discovery/0.2#response.",
      "type": "object",
      "additionalProperties": false,
      "required": [
        "supportedTypes"
