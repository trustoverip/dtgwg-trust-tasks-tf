...
export interface DIDManagementDeletePayload {
  mnemonic: string;
  /**
   * Optional explicit hosting domain. See [category conventions §1](../../../_shared/0.1/CONVENTIONS.md#1-domain-resolution).
   */
  domain?: string;
  ext?: Ext;
}
export interface DIDManagementDeleteResponsePayload {
  record: DidRecord;
  ext?: Ext;
}
...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/did-management/did/delete/0.1" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = DIDManagementDeletePayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/did-management/did/delete/0.1#response" as const;

/** Stable alias for this specification's success-response payload shape. */
export type Response = DIDManagementDeleteResponsePayload;
...
export const PAYLOAD_SCHEMA = {
  ...
  "$id": "https://trusttasks.org/spec/did-management/did/delete/0.1",
  "title": "DID Management Delete — payload",
  "type": "object",
  ...
  "properties": {
    ...
    "domain": {
      "type": "string",
      "description": "Optional explicit hosting domain. See [category conventions §1](../../../_shared/0.1/CONVENTIONS.md#1-domain-resolution)."
    },
    "ext": {
      "$ref": "#/$defs/Ext"
    }
  ...
  "$defs": {
    "Response": {
      "$anchor": "response",
      "title": "DID Management Delete — response payload",
      "type": "object",
      "additionalProperties": false,
      "required": [
        "record"
