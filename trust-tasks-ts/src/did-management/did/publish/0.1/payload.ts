...
export interface DIDManagementPublishResponsePayload {
  record: DidRecord;
  ext?: Ext;
}
...
export type Payload = DIDManagementPublishPayload;
...
export type Response = DIDManagementPublishResponsePayload;
