...
export interface DIDManagementSetStateResponsePayload {
  record: DidRecord;
  ext?: Ext;
}
...
export type Payload = DIDManagementSetStatePayload;
...
export type Response = DIDManagementSetStateResponsePayload;
