...
export interface DIDManagementRollbackPayload {
  mnemonic: string;
  targetVersion: number;
  domain?: string;
  ext?: Ext;
}
export interface DIDManagementRollbackResponsePayload {
  record: DidRecord;
...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/did-management/did/rollback/0.1" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = DIDManagementRollbackPayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/did-management/did/rollback/0.1#response" as const;

/** Stable alias for this specification's success-response payload shape. */
export type Response = DIDManagementRollbackResponsePayload;
