...
export interface DIDManagementUpdateAgentNameResponsePayload {
  record: DidRecord;
  ext?: Ext;
}
...
export type Payload = DIDManagementUpdateAgentNamePayload;
...
export type Response = DIDManagementUpdateAgentNameResponsePayload;
