...
export interface DIDManagementSetAgentNameResponsePayload {
  record: DidRecord;
  ext?: Ext;
}
...
export type Payload = DIDManagementSetAgentNamePayload;
...
export type Response = DIDManagementSetAgentNameResponsePayload;
