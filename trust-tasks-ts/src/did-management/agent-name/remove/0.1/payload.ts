...
export interface DIDManagementRemoveAgentNameResponsePayload {
  record: DidRecord;
  ext?: Ext;
}
...
export type Payload = DIDManagementRemoveAgentNamePayload;
...
export type Response = DIDManagementRemoveAgentNameResponsePayload;
