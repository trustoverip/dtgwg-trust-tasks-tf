...
import type { AndroidApp_VaultV0_2 as AndroidApp, AttachmentRef_VaultV0_3 as AttachmentRef, Did_VaultV0_2 as Did, DidcommAuthcryptEnvelope_VaultV0_2 as DidcommAuthcryptEnvelope, DigestMultibase, Ext, HpkeArmoredEnvelope_VaultV0_2 as HpkeArmoredEnvelope, IosApp_VaultV0_2 as IosApp, SealedEnvelope_VaultV0_2 as SealedEnvelope, SecretKind_VaultV0_2 as SecretKind, SiteTarget_VaultV0_2 as SiteTarget, TspMessageEnvelope_VaultV0_2 as TspMessageEnvelope, VaultEntry_VaultV0_3 as VaultEntry, WebOrigin_VaultV0_2 as WebOrigin } from "../../../_shared/components.js";
...
export type { AndroidApp, AttachmentRef, Did, DidcommAuthcryptEnvelope, DigestMultibase, Ext, HpkeArmoredEnvelope, IosApp, SealedEnvelope, SecretKind, SiteTarget, TspMessageEnvelope, VaultEntry, WebOrigin };

/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/vault/upsert/0.3" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = VaultUpsertPayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/vault/upsert/0.3#response" as const;
