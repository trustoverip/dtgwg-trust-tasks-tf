...
import type { AndroidApp_VaultV0_2 as AndroidApp, AttachmentRef_VaultV0_3 as AttachmentRef, Did_VaultV0_2 as Did, DigestMultibase, Ext, IosApp_VaultV0_2 as IosApp, SecretKind_VaultV0_2 as SecretKind, SiteTarget_VaultV0_2 as SiteTarget, VaultEntry_VaultV0_3 as VaultEntry, WebOrigin_VaultV0_2 as WebOrigin } from "../../../_shared/components.js";
...
export type { AndroidApp, AttachmentRef, Did, DigestMultibase, Ext, IosApp, SecretKind, SiteTarget, VaultEntry, WebOrigin };

/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/vault/list/0.3" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = VaultListPayload;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/vault/list/0.3#response" as const;
