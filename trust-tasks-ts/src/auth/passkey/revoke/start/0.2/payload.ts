...
/** Trust Task type URI. */
export const TYPE_URI = "https://trusttasks.org/spec/auth/passkey/revoke/start/0.2" as const;

/** Stable alias for this specification's request payload shape. */
export type Payload = AuthPasskeyRevokeStart;

/** Trust Task response type URI (request type URI + "#response"). */
export const RESPONSE_TYPE_URI = "https://trusttasks.org/spec/auth/passkey/revoke/start/0.2#response" as const;
