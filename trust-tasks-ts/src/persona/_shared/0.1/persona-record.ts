 ...
 */
export type { Attribute, ClaimType, ContactDocument, ContactRevision, ExpectedVersion_PersonaV0_1 as ExpectedVersion, FaceReach, FacetColour, Profile, ProfileEntry, ProofRung, Provenance, ReleaseRequirement, ResolvedClaim, Sensitivity, Slot, Ulid, ValueType, Version_PersonaV0_1 as Version } from "../../../_shared/components.js";
