...
- **vtc/registry**: An operator surface for the trust-registry reconciler (#460)
...
- **keys**: A key can be marked as never leaving its custodian (#443)
...
- **vta/contexts/secrets**: A service fetches the keys of the DID it operates (#440)
...
- **process-attestation**: Add a provenance category, tighten the digest floor, drop the duplicated byteLength (#437)
